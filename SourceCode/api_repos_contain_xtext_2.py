...
def search_github_repositories():
    ...
    # 获取2019年1月1日的日期
    since_date = datetime.datetime(2018, 1, 1).isoformat()
    ...
    while True:
        ...
        url = f'https://api.github.com/search/repositories?q=.xtext+created:{since_date}..{current_date}+fork:false&page={page}&per_page=100'
...
def write_to_file(data, page):
    # 将结果写入到对应的文件中
    filename = f'SourceCode/search_results/Python_search_results_{page}.txt'
