...
/**
 * This is the item provider adapter for a {@link es.udima.cesarlaso.tfm.timers.Time} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TimersPackage.Literals.TIME__HOUR,
				 true,
				 false,
				 false,
	...
	protected void addMinutePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Time_minute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Time_minute_feature", "_UI_Time_type"),
				 TimersPackage.Literals.TIME__MINUTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addSecondPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Time_second_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Time_second_feature", "_UI_Time_type"),
				 TimersPackage.Literals.TIME__SECOND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
