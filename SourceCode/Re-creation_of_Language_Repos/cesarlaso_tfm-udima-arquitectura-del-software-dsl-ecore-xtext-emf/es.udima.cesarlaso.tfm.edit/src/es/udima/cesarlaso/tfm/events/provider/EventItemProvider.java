...
/**
 * This is the item provider adapter for a {@link es.udima.cesarlaso.tfm.events.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_actuators_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_actuators_feature", "_UI_Event_type"),
				 EventsPackage.Literals.EVENT__ACTUATORS,
				 true,
				 false,
				 true,
				 null,
