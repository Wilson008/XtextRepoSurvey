...
/**
 * This is the item provider adapter for a {@link es.udima.cesarlaso.tfm.gpios.AnalogPin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalogPinItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GpiosPackage.Literals.PIN__NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addResolutionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalogPin_resolution_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalogPin_resolution_feature", "_UI_AnalogPin_type"),
				 GpiosPackage.Literals.ANALOG_PIN__RESOLUTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public ResourceLocator getResourceLocator() {
		return GpiosEditPlugin.INSTANCE;
	}
