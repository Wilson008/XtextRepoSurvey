 ...
 * </p>
 * <ul>
 *   <li>{@link es.udima.cesarlaso.tfm.timers.impl.TimeImpl#getHour <em>Hour</em>}</li>
 *   <li>{@link es.udima.cesarlaso.tfm.timers.impl.TimeImpl#getMinute <em>Minute</em>}</li>
 *   <li>{@link es.udima.cesarlaso.tfm.timers.impl.TimeImpl#getSecond <em>Second</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends MinimalEObjectImpl.Container implements Time {
	...
	protected EClass eStaticClass() {
		return TimersPackage.Literals.TIME;
	}
	...
	public void setHour(int newHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimersPackage.TIME__HOUR, oldHour, hour));
	}
	...
	public void setMinute(int newMinute) {
		...
		minute = newMinute;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimersPackage.TIME__MINUTE, oldMinute, minute));
	}
	...
	public void setSecond(int newSecond) {
		...
		second = newSecond;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimersPackage.TIME__SECOND, oldSecond, second));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TimersPackage.TIME__HOUR:
				return getHour();
			case TimersPackage.TIME__MINUTE:
				return getMinute();
			case TimersPackage.TIME__SECOND:
				return getSecond();
		}
