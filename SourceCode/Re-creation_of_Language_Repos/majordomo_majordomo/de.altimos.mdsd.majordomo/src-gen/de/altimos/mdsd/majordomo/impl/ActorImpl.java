 ...
 * </p>
 * <ul>
 *   <li>{@link de.altimos.mdsd.majordomo.impl.ActorImpl#getCtx <em>Ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActorImpl extends ExtensionImpl implements Actor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return MajordomoPackage.Literals.ACTOR;
	}
	...
	public Extendable getCtx() {
		if (eContainerFeatureID() != MajordomoPackage.ACTOR__CTX) return null;
	...
	public NotificationChain basicSetCtx(Extendable newCtx, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCtx, MajordomoPackage.ACTOR__CTX, msgs);
		return msgs;
	}
	...
	public void setCtx(Extendable newCtx) {
		if (newCtx != eInternalContainer() || (eContainerFeatureID() != MajordomoPackage.ACTOR__CTX && newCtx != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MajordomoPackage.ACTOR__CTX, newCtx, newCtx));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MajordomoPackage.ACTOR__CTX:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
