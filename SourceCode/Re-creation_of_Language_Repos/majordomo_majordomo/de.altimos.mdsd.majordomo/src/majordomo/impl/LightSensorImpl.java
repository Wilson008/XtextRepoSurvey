 ...
 * </p>
 * <ul>
 *   <li>{@link majordomo.impl.LightSensorImpl#getName <em>Name</em>}</li>
 *   <li>{@link majordomo.impl.LightSensorImpl#getCtx <em>Ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LightSensorImpl extends MinimalEObjectImpl.Container implements LightSensor {
	/**
	...
	protected EClass eStaticClass() {
		return MajordomoPackage.Literals.LIGHT_SENSOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MajordomoPackage.LIGHT_SENSOR__NAME, oldName, name));
	}
	...
	public Extendable getCtx() {
		if (eContainerFeatureID() != MajordomoPackage.LIGHT_SENSOR__CTX) return null;
	...
	public NotificationChain basicSetCtx(Extendable newCtx, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCtx, MajordomoPackage.LIGHT_SENSOR__CTX, msgs);
		return msgs;
	}
	...
	public void setCtx(Extendable newCtx) {
		if (newCtx != eInternalContainer() || (eContainerFeatureID() != MajordomoPackage.LIGHT_SENSOR__CTX && newCtx != null)) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MajordomoPackage.LIGHT_SENSOR__CTX:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MajordomoPackage.LIGHT_SENSOR__NAME:
				return getName();
			case MajordomoPackage.LIGHT_SENSOR__CTX:
				return getCtx();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == FloatSensor.class) {
			switch (baseOperationID) {
				case MajordomoPackage.FLOAT_SENSOR___GET_VALUE: return MajordomoPackage.LIGHT_SENSOR___GET_VALUE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MajordomoPackage.LIGHT_SENSOR___GET_VALUE:
				return getValue();
		}
