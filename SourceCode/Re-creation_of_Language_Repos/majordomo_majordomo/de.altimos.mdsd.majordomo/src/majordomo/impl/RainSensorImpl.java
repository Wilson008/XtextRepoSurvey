 ...
 * </p>
 * <ul>
 *   <li>{@link majordomo.impl.RainSensorImpl#getName <em>Name</em>}</li>
 *   <li>{@link majordomo.impl.RainSensorImpl#getCtx <em>Ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RainSensorImpl extends MinimalEObjectImpl.Container implements RainSensor {
	/**
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == BooleanSensor.class) {
			switch (baseOperationID) {
				case MajordomoPackage.BOOLEAN_SENSOR___GET_VALUE: return MajordomoPackage.RAIN_SENSOR___GET_VALUE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MajordomoPackage.RAIN_SENSOR___GET_VALUE:
				return getValue();
		}
