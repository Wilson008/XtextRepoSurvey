...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Radiator Actor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link majordomo.impl.RadiatorActorImpl#getName <em>Name</em>}</li>
 *   <li>{@link majordomo.impl.RadiatorActorImpl#getCtx <em>Ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RadiatorActorImpl extends MinimalEObjectImpl.Container implements RadiatorActor {
	/**
	...
	public Extendable getCtx() {
		if (eContainerFeatureID() != MajordomoPackage.RADIATOR_ACTOR__CTX) return null;
	...
	public NotificationChain basicSetCtx(Extendable newCtx, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCtx, MajordomoPackage.RADIATOR_ACTOR__CTX, msgs);
		return msgs;
	}
	...
	public void setCtx(Extendable newCtx) {
		if (newCtx != eInternalContainer() || (eContainerFeatureID() != MajordomoPackage.RADIATOR_ACTOR__CTX && newCtx != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MajordomoPackage.RADIATOR_ACTOR__CTX, newCtx, newCtx));
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == BooleanActor.class) {
			switch (baseOperationID) {
				case MajordomoPackage.BOOLEAN_ACTOR___SET_VALUE__BOOLEAN: return MajordomoPackage.RADIATOR_ACTOR___SET_VALUE__BOOLEAN;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MajordomoPackage.RADIATOR_ACTOR___SET_VALUE__BOOLEAN:
