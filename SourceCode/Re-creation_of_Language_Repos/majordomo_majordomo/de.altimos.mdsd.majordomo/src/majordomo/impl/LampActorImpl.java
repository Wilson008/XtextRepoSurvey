 ...
 * </p>
 * <ul>
 *   <li>{@link majordomo.impl.LampActorImpl#getName <em>Name</em>}</li>
 *   <li>{@link majordomo.impl.LampActorImpl#getCtx <em>Ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LampActorImpl extends MinimalEObjectImpl.Container implements LampActor {
	/**
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == FloatActor.class) {
			switch (baseOperationID) {
				case MajordomoPackage.FLOAT_ACTOR___SET_VALUE__FLOAT: return MajordomoPackage.LAMP_ACTOR___SET_VALUE__FLOAT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MajordomoPackage.LAMP_ACTOR___SET_VALUE__FLOAT:
