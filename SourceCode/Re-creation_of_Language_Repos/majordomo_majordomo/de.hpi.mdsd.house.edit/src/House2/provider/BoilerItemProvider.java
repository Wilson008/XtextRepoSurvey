...
/**
 * This is the item provider adapter for a {@link House2.Boiler} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoilerItemProvider extends ActorItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Boiler_isOn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Boiler_isOn_feature", "_UI_Boiler_type"),
				 House2Package.Literals.BOILER__IS_ON,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Boiler)object).getName();
