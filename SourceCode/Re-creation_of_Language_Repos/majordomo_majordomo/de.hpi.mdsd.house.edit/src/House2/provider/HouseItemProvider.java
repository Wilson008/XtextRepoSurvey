...
/**
 * This is the item provider adapter for a {@link House2.House} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HouseItemProvider extends ContainerItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(House2Package.Literals.HOUSE__ROOMS);
			childrenFeatures.add(House2Package.Literals.HOUSE__CONTROL_RULES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(House2Package.Literals.HOUSE__ROOMS,
				 House2Factory.eINSTANCE.createRoom()));

		newChildDescriptors.add
			(createChildParameter
				(House2Package.Literals.HOUSE__CONTROL_RULES,
				 House2Factory.eINSTANCE.createControlRule()));
	}
