 ...
 * </p>
 * <ul>
 *   <li>{@link House2.impl.ActorImpl#getIsLocatedIn <em>Is Located In</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActorImpl extends NamedElementImpl implements Actor {
	/**
	...
	protected EClass eStaticClass() {
		return House2Package.Literals.ACTOR;
	}
		...
		if (isLocatedIn != null && isLocatedIn.eIsProxy()) {
			...
			if (isLocatedIn != oldIsLocatedIn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, House2Package.ACTOR__IS_LOCATED_IN, oldIsLocatedIn, isLocatedIn));
			}
		}
		return isLocatedIn;
	}
	...
	public void setIsLocatedIn(House2.Container newIsLocatedIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, House2Package.ACTOR__IS_LOCATED_IN, oldIsLocatedIn, isLocatedIn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case House2Package.ACTOR__IS_LOCATED_IN:
