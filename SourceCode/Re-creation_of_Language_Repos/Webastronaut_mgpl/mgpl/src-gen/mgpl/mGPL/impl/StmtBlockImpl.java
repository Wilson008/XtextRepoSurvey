 ...
 * </p>
 * <ul>
 *   <li>{@link mgpl.mGPL.impl.StmtBlockImpl#getStmts <em>Stmts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StmtBlockImpl extends MinimalEObjectImpl.Container implements StmtBlock
{
  ...
  public EList<Stmt> getStmts()
  {
    if (stmts == null)
    {
      stmts = new EObjectContainmentEList<Stmt>(Stmt.class, this, MGPLPackage.STMT_BLOCK__STMTS);
    }
    return stmts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MGPLPackage.STMT_BLOCK__STMTS:
