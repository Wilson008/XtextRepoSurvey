...
public class RosNetworkDslInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new RosNetworkDslStandaloneSetup() {
			@Override
	...
	protected RosNetworkDslRuntimeModule createRuntimeModule() {
		...
		return new RosNetworkDslRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return RosNetworkDslInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
