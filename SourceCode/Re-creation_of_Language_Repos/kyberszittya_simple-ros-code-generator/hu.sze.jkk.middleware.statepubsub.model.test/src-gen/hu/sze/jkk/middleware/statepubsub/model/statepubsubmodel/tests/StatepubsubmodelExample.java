...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>statepubsubmodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class StatepubsubmodelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.statepubsubmodel"));
				Stack root = StatepubsubmodelFactory.eINSTANCE.createStack();
