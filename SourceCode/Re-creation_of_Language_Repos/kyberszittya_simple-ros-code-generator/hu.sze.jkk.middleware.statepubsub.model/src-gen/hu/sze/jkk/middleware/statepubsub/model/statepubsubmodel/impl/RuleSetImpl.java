 ...
 * </p>
 * <ul>
 *   <li>{@link hu.sze.jkk.middleware.statepubsub.model.statepubsubmodel.impl.RuleSetImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RuleSetImpl extends MinimalEObjectImpl.Container implements RuleSet {
	...
	protected EClass eStaticClass() {
		return StatepubsubmodelPackage.Literals.RULE_SET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatepubsubmodelPackage.RULE_SET__NAME, oldName,
					name));
	}
