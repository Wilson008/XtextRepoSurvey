 ...
 * </p>
 * <ul>
 *   <li>{@link hu.sze.jkk.middleware.statepubsub.model.statepubsubmodel.impl.ServiceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceImpl extends ChannelImpl implements Service {
	/**
	...
	protected EClass eStaticClass() {
		return StatepubsubmodelPackage.Literals.SERVICE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StatepubsubmodelPackage.SERVICE__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(ServiceType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatepubsubmodelPackage.SERVICE__TYPE, oldType,
					type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StatepubsubmodelPackage.SERVICE__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		}
