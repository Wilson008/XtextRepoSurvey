 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.TableElementImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.TableElementImpl#getLabelVisible <em>Label Visible</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.TableElementImpl#getGridHeight <em>Grid Height</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.TableElementImpl#getGridWidth <em>Grid Width</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.TableElementImpl#getWidthInPixels <em>Width In Pixels</em>}</li>
...
public class TableElementImpl extends FormFieldElementImpl implements TableElement
{
    ...
    if (text != null && text.eIsProxy())
    {
      ...
      if (text != oldText)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SamlPackage.TABLE_ELEMENT__TEXT, oldText, text));
      }
    }
    return text;
  }
  ...
  public void setText(TranslationElement newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.TABLE_ELEMENT__TEXT, oldText, text));
  }
  ...
  public void setLabelVisible(String newLabelVisible)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.TABLE_ELEMENT__LABEL_VISIBLE, oldLabelVisible, labelVisible));
  }
  ...
  public void setGridWidth(int newGridWidth)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.TABLE_ELEMENT__GRID_WIDTH, oldGridWidth, gridWidth));
  }
  ...
  public void setWidthInPixels(int newWidthInPixels)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.TABLE_ELEMENT__WIDTH_IN_PIXELS, oldWidthInPixels, widthInPixels));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SamlPackage.TABLE_ELEMENT__TEXT:
        if (resolve) return getText();
        return basicGetText();
      case SamlPackage.TABLE_ELEMENT__LABEL_VISIBLE:
        return getLabelVisible();
      case SamlPackage.TABLE_ELEMENT__GRID_HEIGHT:
        return getGridHeight();
      case SamlPackage.TABLE_ELEMENT__GRID_WIDTH:
        return getGridWidth();
      case SamlPackage.TABLE_ELEMENT__WIDTH_IN_PIXELS:
