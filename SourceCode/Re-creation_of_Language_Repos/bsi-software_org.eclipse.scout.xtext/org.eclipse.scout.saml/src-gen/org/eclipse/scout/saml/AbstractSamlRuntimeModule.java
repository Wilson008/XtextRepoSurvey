...
import org.eclipse.scout.saml.jvmmodel.SamlJvmModelInferrer;
import org.eclipse.scout.saml.parser.antlr.SamlAntlrTokenFileProvider;
import org.eclipse.scout.saml.parser.antlr.SamlParser;
import org.eclipse.scout.saml.parser.antlr.internal.InternalSamlLexer;
import org.eclipse.scout.saml.scoping.SamlScopeProvider;
import org.eclipse.scout.saml.serializer.SamlSemanticSequencer;
import org.eclipse.scout.saml.serializer.SamlSyntacticSequencer;
import org.eclipse.scout.saml.services.SamlGrammarAccess;
import org.eclipse.scout.saml.validation.SamlConfigurableIssueCodesProvider;
import org.eclipse.scout.saml.validation.SamlValidator;
...
/**
 * Manual modifications go to {@link SamlRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSamlRuntimeModule extends DefaultXbaseRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/scout/saml/Saml.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.scout.saml.Saml");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("saml");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return SamlGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return SamlSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return SamlSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return SamlAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalSamlLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalSamlLexer> provideInternalSamlLexer() {
		return LexerProvider.create(InternalSamlLexer.class);
	}
	...
	public Class<? extends SamlValidator> bindSamlValidator() {
		return SamlValidator.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends XbaseConfigurableIssueCodes> bindXbaseConfigurableIssueCodes() {
		return SamlConfigurableIssueCodesProvider.class;
	}
	...
	public Class<? extends IJvmModelInferrer> bindIJvmModelInferrer() {
		return SamlJvmModelInferrer.class;
	}
