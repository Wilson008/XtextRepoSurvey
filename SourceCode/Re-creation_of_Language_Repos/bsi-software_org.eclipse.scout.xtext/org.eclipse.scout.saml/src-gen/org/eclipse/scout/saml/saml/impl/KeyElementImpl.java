 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.KeyElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.KeyElementImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.KeyElementImpl#getLogic <em>Logic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KeyElementImpl extends MinimalEObjectImpl.Container implements KeyElement
{
  ...
  {
    return SamlPackage.Literals.KEY_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.KEY_ELEMENT__NAME, oldName, name));
  }
  ...
  public void setStroke(String newStroke)
  {
    ...
    stroke = newStroke;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.KEY_ELEMENT__STROKE, oldStroke, stroke));
  }
  ...
  public EList<LogicElement> getLogic()
  {
    if (logic == null)
    {
      logic = new EObjectContainmentEList<LogicElement>(LogicElement.class, this, SamlPackage.KEY_ELEMENT__LOGIC);
    }
    return logic;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SamlPackage.KEY_ELEMENT__LOGIC:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SamlPackage.KEY_ELEMENT__NAME:
        return getName();
      case SamlPackage.KEY_ELEMENT__STROKE:
        return getStroke();
      case SamlPackage.KEY_ELEMENT__LOGIC:
        return getLogic();
    }
