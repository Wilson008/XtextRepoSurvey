...
import org.eclipse.scout.saml.ide.contentassist.antlr.PartialSamlContentAssistParser;
import org.eclipse.scout.saml.ide.contentassist.antlr.SamlParser;
import org.eclipse.scout.saml.ide.contentassist.antlr.internal.InternalSamlLexer;
import org.eclipse.scout.saml.ui.contentassist.SamlProposalProvider;
import org.eclipse.scout.saml.ui.editor.SamlEditor;
import org.eclipse.scout.saml.ui.labeling.SamlDescriptionLabelProvider;
import org.eclipse.scout.saml.ui.labeling.SamlLabelProvider;
import org.eclipse.scout.saml.ui.outline.SamlOutlineTreeProvider;
import org.eclipse.scout.saml.ui.quickfix.SamlQuickfixProvider;
import org.eclipse.scout.saml.validation.SamlValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link SamlUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSamlUiModule extends DefaultXbaseUiModule {

	public AbstractSamlUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.scout.saml.parser.antlr.internal.InternalSamlLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return SamlParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSamlLexer.class).toProvider(LexerProvider.create(InternalSamlLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return SamlValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return SamlLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(SamlDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return SamlOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return SamlQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return SamlProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSamlContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Saml Compare");
	}
