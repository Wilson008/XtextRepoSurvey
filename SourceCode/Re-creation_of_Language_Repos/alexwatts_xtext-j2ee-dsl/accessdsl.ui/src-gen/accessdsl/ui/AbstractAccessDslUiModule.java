...
import accessdsl.ide.contentassist.antlr.PartialAccessDslContentAssistParser;
import accessdsl.ide.contentassist.antlr.internal.InternalAccessDslLexer;
import accessdsl.ui.contentassist.AccessDslProposalProvider;
import accessdsl.ui.editor.AccessDslEditor;
import accessdsl.ui.labeling.AccessDslDescriptionLabelProvider;
import accessdsl.ui.labeling.AccessDslLabelProvider;
import accessdsl.ui.outline.AccessDslOutlineTreeProvider;
import accessdsl.ui.quickfix.AccessDslQuickfixProvider;
import accessdsl.validation.AccessDslValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link AccessDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractAccessDslUiModule extends DefaultXbaseUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(accessdsl.parser.antlr.internal.InternalAccessDslLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalAccessDslLexer.class).toProvider(LexerProvider.create(InternalAccessDslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return AccessDslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return AccessDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(AccessDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return AccessDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return AccessDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return AccessDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialAccessDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("AccessDsl Compare");
	}
