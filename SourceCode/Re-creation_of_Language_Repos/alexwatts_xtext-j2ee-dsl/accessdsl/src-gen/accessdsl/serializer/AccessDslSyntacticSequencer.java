...
public class AccessDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected AccessDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (AccessDslGrammarAccess) access;
