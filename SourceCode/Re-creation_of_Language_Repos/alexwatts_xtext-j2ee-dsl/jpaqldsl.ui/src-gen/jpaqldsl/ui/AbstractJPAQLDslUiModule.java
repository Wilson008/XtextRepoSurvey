...
import jpaqldsl.ide.contentassist.antlr.JPAQLDslParser;
import jpaqldsl.ide.contentassist.antlr.PartialJPAQLDslContentAssistParser;
import jpaqldsl.ide.contentassist.antlr.internal.InternalJPAQLDslLexer;
import jpaqldsl.ui.contentassist.JPAQLDslProposalProvider;
import jpaqldsl.ui.editor.JPAQLDslEditor;
import jpaqldsl.ui.labeling.JPAQLDslDescriptionLabelProvider;
import jpaqldsl.ui.labeling.JPAQLDslLabelProvider;
import jpaqldsl.ui.outline.JPAQLDslOutlineTreeProvider;
import jpaqldsl.ui.quickfix.JPAQLDslQuickfixProvider;
import jpaqldsl.validation.JPAQLDslValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link JPAQLDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractJPAQLDslUiModule extends DefaultXbaseUiModule {
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalJPAQLDslLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(jpaqldsl.parser.antlr.internal.InternalJPAQLDslLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return JPAQLDslParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalJPAQLDslLexer.class).toProvider(LexerProvider.create(InternalJPAQLDslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return JPAQLDslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return JPAQLDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(JPAQLDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return JPAQLDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return JPAQLDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return JPAQLDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialJPAQLDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("JPAQLDsl Compare");
	}
