 ...
 */
package accessdsl.ide.contentassist.antlr;

import accessdsl.ide.contentassist.antlr.internal.InternalAccessDslParser;
...
public class AccessDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(AccessDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AccessDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getQueryMappingAccess().getAlternatives(), "rule__QueryMapping__Alternatives");
			builder.put(grammarAccess.getStateOperationAccess().getAlternatives(), "rule__StateOperation__Alternatives");
			...
			builder.put(grammarAccess.getContainerElementAccess().getGroup(), "rule__ContainerElement__Group__0");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getGroup(), "rule__QueryAndTypeMapping__Group__0");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getGroup_9(), "rule__QueryAndTypeMapping__Group_9__0");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getGroup_9_1(), "rule__QueryAndTypeMapping__Group_9_1__0");
			builder.put(grammarAccess.getSingleResultQueryMappingAccess().getGroup(), "rule__SingleResultQueryMapping__Group__0");
			builder.put(grammarAccess.getMultipleResultQueryMappingAccess().getGroup(), "rule__MultipleResultQueryMapping__Group__0");
			builder.put(grammarAccess.getStateAdjustmentAccess().getGroup(), "rule__StateAdjustment__Group__0");
			builder.put(grammarAccess.getPersistOperationAccess().getGroup(), "rule__PersistOperation__Group__0");
			builder.put(grammarAccess.getPersistAndAssociateOperationAccess().getGroup(), "rule__PersistAndAssociateOperation__Group__0");
			builder.put(grammarAccess.getAssociateOperationAccess().getGroup(), "rule__AssociateOperation__Group__0");
			...
			builder.put(grammarAccess.getImportedNamespaceAccess().getGroup_1(), "rule__ImportedNamespace__Group_1__0");
			...
			builder.put(grammarAccess.getModelAccess().getUnitAssignment_1(), "rule__Model__UnitAssignment_1");
			...
			builder.put(grammarAccess.getUnitAccess().getPackageAssignment_3(), "rule__Unit__PackageAssignment_3");
			builder.put(grammarAccess.getUnitAccess().getContainersAssignment_4(), "rule__Unit__ContainersAssignment_4");
			builder.put(grammarAccess.getUnitAccess().getQuerymappingAssignment_5(), "rule__Unit__QuerymappingAssignment_5");
			builder.put(grammarAccess.getUnitAccess().getStateAdjustmentAssignment_6(), "rule__Unit__StateAdjustmentAssignment_6");
			...
			builder.put(grammarAccess.getContainerAccess().getContainerElementsAssignment_3(), "rule__Container__ContainerElementsAssignment_3");
			builder.put(grammarAccess.getContainerElementAccess().getEntityAssignment_1(), "rule__ContainerElement__EntityAssignment_1");
			builder.put(grammarAccess.getContainerElementAccess().getAliasAssignment_2(), "rule__ContainerElement__AliasAssignment_2");
			builder.put(grammarAccess.getContainedEntityAccess().getContainedAssignment(), "rule__ContainedEntity__ContainedAssignment");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getNameAssignment_1(), "rule__QueryAndTypeMapping__NameAssignment_1");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getImportsAssignment_3(), "rule__QueryAndTypeMapping__ImportsAssignment_3");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getQueryAssignment_4(), "rule__QueryAndTypeMapping__QueryAssignment_4");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getTypeMappingAssignment_6(), "rule__QueryAndTypeMapping__TypeMappingAssignment_6");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getQueryParametersAssignment_9_0(), "rule__QueryAndTypeMapping__QueryParametersAssignment_9_0");
			builder.put(grammarAccess.getQueryAndTypeMappingAccess().getQueryParametersAssignment_9_1_1(), "rule__QueryAndTypeMapping__QueryParametersAssignment_9_1_1");
			builder.put(grammarAccess.getSingleResultQueryMappingAccess().getNamedQueryAssignment_1(), "rule__SingleResultQueryMapping__NamedQueryAssignment_1");
			builder.put(grammarAccess.getMultipleResultQueryMappingAccess().getNamedQueryAssignment_1(), "rule__MultipleResultQueryMapping__NamedQueryAssignment_1");
			builder.put(grammarAccess.getStateAdjustmentAccess().getNameAssignment_2(), "rule__StateAdjustment__NameAssignment_2");
			builder.put(grammarAccess.getStateAdjustmentAccess().getImportsAssignment_3(), "rule__StateAdjustment__ImportsAssignment_3");
			builder.put(grammarAccess.getStateAdjustmentAccess().getStateOperationAssignment_4(), "rule__StateAdjustment__StateOperationAssignment_4");
			builder.put(grammarAccess.getPersistOperationAccess().getThisAssignment_1(), "rule__PersistOperation__ThisAssignment_1");
			builder.put(grammarAccess.getPersistAndAssociateOperationAccess().getNewEntityAssignment_1(), "rule__PersistAndAssociateOperation__NewEntityAssignment_1");
			builder.put(grammarAccess.getPersistAndAssociateOperationAccess().getAssocialtionAssignment_2(), "rule__PersistAndAssociateOperation__AssocialtionAssignment_2");
			builder.put(grammarAccess.getPersistAndAssociateOperationAccess().getExistingEntityAssignment_3(), "rule__PersistAndAssociateOperation__ExistingEntityAssignment_3");
			builder.put(grammarAccess.getAssociateOperationAccess().getThisAssignment_1(), "rule__AssociateOperation__ThisAssignment_1");
			builder.put(grammarAccess.getAssociateOperationAccess().getAssocialtionAssignment_2(), "rule__AssociateOperation__AssocialtionAssignment_2");
			builder.put(grammarAccess.getAssociateOperationAccess().getThatAssignment_3(), "rule__AssociateOperation__ThatAssignment_3");
			builder.put(grammarAccess.getUpdateOperationAccess().getThisAssignment_1(), "rule__UpdateOperation__ThisAssignment_1");
			builder.put(grammarAccess.getDeleteOperationAccess().getThisAssignment_1(), "rule__DeleteOperation__ThisAssignment_1");
	...
	@Override
	protected InternalAccessDslParser createParser() {
		InternalAccessDslParser result = new InternalAccessDslParser(null);
