 ...
 * </p>
 * <ul>
 *   <li>{@link jpadsl.jPADsl.impl.ReferenceImpl#getOpposite <em>Opposite</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends StructuralFeatureImpl implements Reference
{
  ...
  {
    return JPADslPackage.Literals.REFERENCE;
  }
    ...
    if (opposite != null && opposite.eIsProxy())
    {
      ...
      if (opposite != oldOpposite)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, JPADslPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
      }
    }
    return opposite;
  }
  ...
  public void setOpposite(Reference newOpposite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JPADslPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JPADslPackage.REFERENCE__OPPOSITE:
