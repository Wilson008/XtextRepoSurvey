...
public class MiniScriptSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     (rule start) (ambiguity) 'func' '(' ')' body=Expression
	 *     (rule start) (ambiguity) 'func' '(' parameters+=ID
	 *     (rule start) (ambiguity) 'let' assigment=VariableAssignment
	 *     (rule start) (ambiguity) '{' expressions+=Expression
	 *     (rule start) (ambiguity) id=ID
	 *     (rule start) (ambiguity) operator=BinaryLogicalOperator
	 *     (rule start) (ambiguity) operator=TernaryOperator
	 *     (rule start) (ambiguity) operator=UnaryLogicalOperator
	 *     (rule start) (ambiguity) value=BooleanValue
	 *     (rule start) (ambiguity) value=INT
	 *     (rule start) (ambiguity) {Apply.functor=}
	 *     (rule start) (ambiguity) {ComparisonExpression.leftExpr=}
	 *     (rule start) (ambiguity) {Factor.leftTerm=}
	 *     (rule start) (ambiguity) {NumericExpression.leftFactor=}
