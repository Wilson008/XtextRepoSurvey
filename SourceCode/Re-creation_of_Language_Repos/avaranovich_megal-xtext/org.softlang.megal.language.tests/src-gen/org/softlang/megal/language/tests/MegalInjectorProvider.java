...
public class MegalInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new MegalStandaloneSetup() {
			@Override
	...
	protected MegalRuntimeModule createRuntimeModule() {
		...
		return new MegalRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return MegalInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
