 ...
 * </p>
 * <ul>
 *   <li>{@link megal.impl.QueryParamImpl#getName <em>Name</em>}</li>
 *   <li>{@link megal.impl.QueryParamImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueryParamImpl extends MinimalEObjectImpl.Container implements QueryParam {
	...
	protected EClass eStaticClass() {
		return MegalPackage.Literals.QUERY_PARAM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MegalPackage.QUERY_PARAM__NAME, oldName, name));
	}
	...
	public MegalEntityType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MegalPackage.QUERY_PARAM__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(MegalEntityType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MegalPackage.QUERY_PARAM__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MegalPackage.QUERY_PARAM__NAME:
				return getName();
			case MegalPackage.QUERY_PARAM__TYPE:
