 ...
 * </p>
 * <ul>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#getRight <em>Right</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#isLeftBoth <em>Left Both</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#isRightBoth <em>Right Both</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#isLeftMany <em>Left Many</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#isRightMany <em>Right Many</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#getLeftParams <em>Left Params</em>}</li>
 *   <li>{@link megal.impl.MegalRelationshipTypeImpl#getRightParams <em>Right Params</em>}</li>
 * </ul>
 *
 * @generated
 */
