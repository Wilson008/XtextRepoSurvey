...
public class InternalMegalLexer extends Lexer {
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:26:7: ( 'from' )
            // InternalMegal.g:26:9: 'from'
            {
            match("from"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:28:7: ( '}' )
            // InternalMegal.g:28:9: '}'
            {
            match('}'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4038:10: ( '1' .. '9' ( '0' .. '9' )* )
            // InternalMegal.g:4038:12: '1' .. '9' ( '0' .. '9' )*
            {
            matchRange('1','9'); 
            // InternalMegal.g:4038:21: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ANN_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4040:13: ( '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:4040:15: '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            match('@'); 
            // InternalMegal.g:4040:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
            ...
            // InternalMegal.g:4040:53: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalMegal.g:4040:54: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:4040:58: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt3=0;
            	    loop3:
            	    do {
            	        int alt3=2;
    ...
    public final void mRULE_VAR_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4042:13: ( '?' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:4042:15: '?' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            match('?'); 
            // InternalMegal.g:4042:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
            ...
            // InternalMegal.g:4042:53: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalMegal.g:4042:54: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:4042:58: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt6=0;
            	    loop6:
            	    do {
            	        int alt6=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4044:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:4044:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            // InternalMegal.g:4044:11: ( '^' )?
            int alt8=2;
            ...
            // InternalMegal.g:4044:16: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt9=0;
            loop9:
            do {
                int alt9=2;
            ...
            // InternalMegal.g:4044:50: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalMegal.g:4044:51: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:4044:55: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt10=0;
            	    loop10:
            	    do {
            	        int alt10=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4046:13: ( '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalMegal.g:4046:15: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalMegal.g:4046:20: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop12:
            do {
                int alt12=3;
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4048:14: ( ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? ) )
            // InternalMegal.g:4048:16: ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            {
            // InternalMegal.g:4048:16: ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalMegal.g:4048:17: '/*' ( options {greedy=false; } : . )* '*/'
                    {
                    match("/*"); 

                    // InternalMegal.g:4048:22: ( options {greedy=false; } : . )*
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalMegal.g:4048:59: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
                    {
                    match("//"); 

                    // InternalMegal.g:4048:64: (~ ( ( '\\n' | '\\r' ) ) )*
                    loop14:
                    do {
                        int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:4050:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMegal.g:4050:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMegal.g:4050:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    static final String DFA19_eotS =
        "\1\uffff\2\27\1\uffff\1\36\3\uffff\2\27\6\uffff\1\27\3\uffff\1\42\6\uffff\2\27\2\uffff\1\46\2\27\1\uffff\1\42\2\27\1\uffff\5\27\1\60\1\61\2\27\2\uffff\1\64\1\65\2\uffff";
    static final String DFA19_eofS =
        "\66\uffff";
    static final String DFA19_minS =
        "\1\11\1\157\1\155\1\uffff\1\53\3\uffff\1\163\1\156\6\uffff\1\162\3\uffff\1\56\6\uffff\1\144\1\160\2\uffff\1\56\1\164\1\157\1\uffff\1\56\1\145\1\157\1\uffff\1\151\1\155\1\154\1\162\1\164\2\56\1\164\1\171\2\uffff\2\56\2\uffff";
    static final String DFA19_maxS =
        "\1\175\1\157\1\155\1\uffff\1\53\3\uffff\1\163\1\156\6\uffff\1\162\3\uffff\1\172\6\uffff\1\144\1\160\2\uffff\1\172\1\164\1\157\1\uffff\1\172\1\145\1\157\1\uffff\1\151\1\155\1\154\1\162\1\164\2\172\1\164\1\171\2\uffff\2\172\2\uffff";
    static final String DFA19_acceptS =
        "\3\uffff\1\3\1\uffff\1\5\1\6\1\7\2\uffff\1\12\1\13\1\14\1\15\1\16\1\17\1\uffff\1\21\1\22\1\24\1\uffff\1\26\1\27\1\30\1\31\1\32\1\33\2\uffff\1\23\1\4\3\uffff\1\25\3\uffff\1\10\11\uffff\1\20\1\1\2\uffff\1\2\1\11";
    static final String DFA19_specialS =
        "\66\uffff}>";
    static final String[] DFA19_transitionS = {
            "\2\32\2\uffff\1\32\22\uffff\1\32\6\uffff\1\30\1\4\1\5\1\12\1\23\1\17\1\15\1\uffff\1\31\1\27\11\24\1\16\1\uffff\1\7\1\3\1\uffff\1\26\1\25\32\27\1\13\1\uffff\1\14\2\27\1\uffff\1\10\3\27\1\11\1\20\2\27\1\2\3\27\1\1\15\27\1\21\1\6\1\22",
            "\1\33",
            "\1\34",
            "",
            "\1\35",
