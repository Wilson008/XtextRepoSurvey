...
public class InternalMegalLexer extends Lexer {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1522:10: ( '1' .. '9' ( '0' .. '9' )* )
            // InternalMegal.g:1522:12: '1' .. '9' ( '0' .. '9' )*
            {
            matchRange('1','9'); 
            // InternalMegal.g:1522:21: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ANN_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1524:13: ( '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:1524:15: '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            match('@'); 
            // InternalMegal.g:1524:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
            ...
            // InternalMegal.g:1524:53: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalMegal.g:1524:54: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:1524:58: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt3=0;
            	    loop3:
            	    do {
            	        int alt3=2;
    ...
    public final void mRULE_VAR_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1526:13: ( '?' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:1526:15: '?' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            match('?'); 
            // InternalMegal.g:1526:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
            ...
            // InternalMegal.g:1526:53: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalMegal.g:1526:54: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:1526:58: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt6=0;
            	    loop6:
            	    do {
            	        int alt6=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1528:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )* )
            // InternalMegal.g:1528:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            {
            // InternalMegal.g:1528:11: ( '^' )?
            int alt8=2;
            ...
            // InternalMegal.g:1528:16: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            int cnt9=0;
            loop9:
            do {
                int alt9=2;
            ...
            // InternalMegal.g:1528:50: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+ )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalMegal.g:1528:51: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalMegal.g:1528:55: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )+
            	    int cnt10=0;
            	    loop10:
            	    do {
            	        int alt10=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1530:13: ( '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalMegal.g:1530:15: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalMegal.g:1530:20: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop12:
            do {
                int alt12=3;
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1532:14: ( ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? ) )
            // InternalMegal.g:1532:16: ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            {
            // InternalMegal.g:1532:16: ( '/*' ( options {greedy=false; } : . )* '*/' | '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalMegal.g:1532:17: '/*' ( options {greedy=false; } : . )* '*/'
                    {
                    match("/*"); 

                    // InternalMegal.g:1532:22: ( options {greedy=false; } : . )*
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalMegal.g:1532:59: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
                    {
                    match("//"); 

                    // InternalMegal.g:1532:64: (~ ( ( '\\n' | '\\r' ) ) )*
                    loop14:
                    do {
                        int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMegal.g:1534:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMegal.g:1534:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMegal.g:1534:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
