...
@parser::members {
    ...
    public InternalEdeltaParser(TokenStream input, EdeltaGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected EdeltaGrammarAccess getGrammarAccess() {
...
entryRuleEdeltaProgram returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaProgramRule()); }
	iv_ruleEdeltaProgram=ruleEdeltaProgram
	{ $current=$iv_ruleEdeltaProgram.current; }
	EOF;

// Rule EdeltaProgram
ruleEdeltaProgram returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getEdeltaProgramAccess().getEdeltaProgramAction_0(),
					$current);
			}
		)
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaProgramAccess().getImportSectionXImportSectionParserRuleCall_1_0());
				}
				lv_importSection_1_0=ruleXImportSection
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaProgramRule());
					}
					set(
						$current,
						"importSection",
		...
		(
			otherlv_2='package'
			{
				newLeafNode(otherlv_2, grammarAccess.getEdeltaProgramAccess().getPackageKeyword_2_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getEdeltaProgramAccess().getNameQualifiedNameParserRuleCall_2_1_0());
					}
			...
			(
				otherlv_4=';'
				{
					newLeafNode(otherlv_4, grammarAccess.getEdeltaProgramAccess().getSemicolonKeyword_2_2());
				}
			)?
		)?
		(
			otherlv_5='metamodel'
			{
				newLeafNode(otherlv_5, grammarAccess.getEdeltaProgramAccess().getMetamodelKeyword_3_0());
			}
			(
				(
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getEdeltaProgramRule());
						}
					}
					otherlv_6=RULE_STRING
					{
						newLeafNode(otherlv_6, grammarAccess.getEdeltaProgramAccess().getMetamodelsEPackageCrossReference_3_1_0());
					}
				)
			)
		)*
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaProgramAccess().getUseAsClausesEdeltaUseAsParserRuleCall_4_0());
				}
				lv_useAsClauses_7_0=ruleEdeltaUseAs
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaProgramRule());
					}
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaProgramAccess().getOperationsEdeltaOperationParserRuleCall_5_0());
				}
				lv_operations_8_0=ruleEdeltaOperation
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaProgramRule());
					}
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaProgramAccess().getModifyEcoreOperationsEdeltaModifyEcoreOperationParserRuleCall_6_0());
				}
				lv_modifyEcoreOperations_9_0=ruleEdeltaModifyEcoreOperation
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaProgramRule());
					}
					add(
						...
						lv_modifyEcoreOperations_9_0,
						"edelta.Edelta.EdeltaModifyEcoreOperation");
					afterParserOrEnumRuleCall();
				}
			)
		)*
...
entryRuleEdeltaUseAs returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaUseAsRule()); }
	iv_ruleEdeltaUseAs=ruleEdeltaUseAs
	{ $current=$iv_ruleEdeltaUseAs.current; }
	EOF;

// Rule EdeltaUseAs
ruleEdeltaUseAs returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getEdeltaUseAsAccess().getEdeltaUseAsAction_0(),
					$current);
			}
		)
		otherlv_1='use'
		{
			newLeafNode(otherlv_1, grammarAccess.getEdeltaUseAsAccess().getUseKeyword_1());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaUseAsAccess().getTypeJvmTypeReferenceParserRuleCall_2_0());
				}
				lv_type_2_0=ruleJvmTypeReference
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaUseAsRule());
					}
					set(
						$current,
						"type",
		...
		otherlv_3='as'
		{
			newLeafNode(otherlv_3, grammarAccess.getEdeltaUseAsAccess().getAsKeyword_3());
		}
		(
			(
				lv_extension_4_0='extension'
				{
					newLeafNode(lv_extension_4_0, grammarAccess.getEdeltaUseAsAccess().getExtensionExtensionKeyword_4_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getEdeltaUseAsRule());
					}
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaUseAsAccess().getNameValidIDParserRuleCall_5_0());
				}
...
entryRuleEdeltaModifyEcoreOperation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaModifyEcoreOperationRule()); }
	iv_ruleEdeltaModifyEcoreOperation=ruleEdeltaModifyEcoreOperation
	{ $current=$iv_ruleEdeltaModifyEcoreOperation.current; }
	EOF;

// Rule EdeltaModifyEcoreOperation
ruleEdeltaModifyEcoreOperation returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getEdeltaModifyEcoreOperationAccess().getEdeltaModifyEcoreOperationAction_0(),
					$current);
			}
		)
		otherlv_1='modifyEcore'
		{
			newLeafNode(otherlv_1, grammarAccess.getEdeltaModifyEcoreOperationAccess().getModifyEcoreKeyword_1());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaModifyEcoreOperationAccess().getNameValidIDParserRuleCall_2_0());
				}
				lv_name_2_0=ruleValidID
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getEdeltaModifyEcoreOperationRule());
					}
					set(
						$current,
						"name",
		...
		otherlv_3='epackage'
		{
			newLeafNode(otherlv_3, grammarAccess.getEdeltaModifyEcoreOperationAccess().getEpackageKeyword_3());
		}
		(
			(
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getEdeltaModifyEcoreOperationRule());
					}
				}
				otherlv_4=RULE_ID
				{
					newLeafNode(otherlv_4, grammarAccess.getEdeltaModifyEcoreOperationAccess().getEpackageEPackageCrossReference_4_0());
				}
			)
		)
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaModifyEcoreOperationAccess().getBodyXBlockExpressionParserRuleCall_5_0());
				}
...
entryRuleEdeltaOperation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaOperationRule()); }
	iv_ruleEdeltaOperation=ruleEdeltaOperation
	{ $current=$iv_ruleEdeltaOperation.current; }
	EOF;

// Rule EdeltaOperation
ruleEdeltaOperation returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getEdeltaOperationAccess().getEdeltaOperationAction_0(),
					$current);
			}
		)
		otherlv_1='def'
		{
			newLeafNode(otherlv_1, grammarAccess.getEdeltaOperationAccess().getDefKeyword_1());
		}
		(
			otherlv_2='<'
			{
				newLeafNode(otherlv_2, grammarAccess.getEdeltaOperationAccess().getLessThanSignKeyword_2_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getEdeltaOperationAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_1_0());
					}
					lv_typeParameters_3_0=ruleJvmTypeParameter
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getEdeltaOperationRule());
						}
						add(
							$current,
							"typeParameters",
			...
			(
				otherlv_4=','
				{
					newLeafNode(otherlv_4, grammarAccess.getEdeltaOperationAccess().getCommaKeyword_2_2_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getEdeltaOperationAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_2_1_0());
						}
			...
			otherlv_6='>'
			{
				newLeafNode(otherlv_6, grammarAccess.getEdeltaOperationAccess().getGreaterThanSignKeyword_2_3());
			}
		)?
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaOperationAccess().getNameValidIDParserRuleCall_3_0());
				}
		...
		otherlv_8='('
		{
			newLeafNode(otherlv_8, grammarAccess.getEdeltaOperationAccess().getLeftParenthesisKeyword_4());
		}
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getEdeltaOperationAccess().getParamsFullJvmFormalParameterParserRuleCall_5_0_0());
					}
			...
			(
				otherlv_10=','
				{
					newLeafNode(otherlv_10, grammarAccess.getEdeltaOperationAccess().getCommaKeyword_5_1_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getEdeltaOperationAccess().getParamsFullJvmFormalParameterParserRuleCall_5_1_1_0());
						}
		...
		otherlv_12=')'
		{
			newLeafNode(otherlv_12, grammarAccess.getEdeltaOperationAccess().getRightParenthesisKeyword_6());
		}
		(
			otherlv_13=':'
			{
				newLeafNode(otherlv_13, grammarAccess.getEdeltaOperationAccess().getColonKeyword_7_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getEdeltaOperationAccess().getTypeJvmTypeReferenceParserRuleCall_7_1_0());
					}
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getEdeltaOperationAccess().getBodyXBlockExpressionParserRuleCall_8_0());
				}
	...
	(
		(
			(
				{
					$current = forceCreateModelElement(
						grammarAccess.getXPrimaryExpressionAccess().getEdeltaEcoreReferenceExpressionAction_0_0(),
						$current);
				}
			)
			otherlv_1='ecoreref'
			{
				newLeafNode(otherlv_1, grammarAccess.getXPrimaryExpressionAccess().getEcorerefKeyword_0_1());
			}
			otherlv_2='('
			{
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getXPrimaryExpressionAccess().getReferenceEdeltaEcoreReferenceParserRuleCall_0_3_0());
					}
					lv_reference_3_0=ruleEdeltaEcoreReference
					{
						if ($current==null) {
						...
						set(
							...
							"reference",
							lv_reference_3_0,
							"edelta.Edelta.EdeltaEcoreReference");
						afterParserOrEnumRuleCall();
					}
				)
			)
			otherlv_4=')'
			{
				newLeafNode(otherlv_4, grammarAccess.getXPrimaryExpressionAccess().getRightParenthesisKeyword_0_4());
			}
		)
		    |
		{
...
entryRuleEdeltaEcoreReference returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaEcoreReferenceRule()); }
	iv_ruleEdeltaEcoreReference=ruleEdeltaEcoreReference
	{ $current=$iv_ruleEdeltaEcoreReference.current; }
	EOF;

// Rule EdeltaEcoreReference
ruleEdeltaEcoreReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getEdeltaEcoreReferenceAccess().getEdeltaEcoreDirectReferenceParserRuleCall_0());
		}
		this_EdeltaEcoreDirectReference_0=ruleEdeltaEcoreDirectReference
		{
			$current = $this_EdeltaEcoreDirectReference_0.current;
			afterParserOrEnumRuleCall();
		}
		(
			(
				{
					$current = forceCreateModelElementAndSet(
						grammarAccess.getEdeltaEcoreReferenceAccess().getEdeltaEcoreQualifiedReferenceQualificationAction_1_0(),
						$current);
				}
			)
			otherlv_2='.'
			{
				newLeafNode(otherlv_2, grammarAccess.getEdeltaEcoreReferenceAccess().getFullStopKeyword_1_1());
			}
			(
				(
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getEdeltaEcoreReferenceRule());
						}
					}
					otherlv_3=RULE_ID
					{
						newLeafNode(otherlv_3, grammarAccess.getEdeltaEcoreReferenceAccess().getEnamedelementENamedElementCrossReference_1_2_0());
					}
				)
			)
		)*
...
entryRuleEdeltaEcoreDirectReference returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEdeltaEcoreDirectReferenceRule()); }
	iv_ruleEdeltaEcoreDirectReference=ruleEdeltaEcoreDirectReference
	{ $current=$iv_ruleEdeltaEcoreDirectReference.current; }
	EOF;

// Rule EdeltaEcoreDirectReference
ruleEdeltaEcoreDirectReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getEdeltaEcoreDirectReferenceAccess().getEdeltaEcoreDirectReferenceAction_0(),
					$current);
			}
		)
		(
			(
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getEdeltaEcoreDirectReferenceRule());
					}
				}
				otherlv_1=RULE_ID
				{
					newLeafNode(otherlv_1, grammarAccess.getEdeltaEcoreDirectReferenceAccess().getEnamedelementENamedElementCrossReference_1_0());
				}
			)
		)
	)
...
@after {
	...
	(
		...
		(
			('extends' | 'static' | 'import' | 'extension' | '!' | '-' | '+' | 'ecoreref' | 'new' | '{' | 'switch' | 'synchronized' | '<' | 'super' | '#' | '[' | 'false' | 'true' | 'null' | 'typeof' | 'if' | 'for' | 'while' | 'do' | 'throw' | 'return' | 'try' | '(' | RULE_ID | RULE_HEX | RULE_INT | RULE_DECIMAL | RULE_STRING)=>
			(
				{
