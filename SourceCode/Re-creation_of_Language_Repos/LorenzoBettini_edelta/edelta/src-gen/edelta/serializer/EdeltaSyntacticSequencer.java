...
public class EdeltaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EdeltaGrammarAccess grammarAccess;
	protected AbstractElementAlias match_EdeltaProgram_SemicolonKeyword_2_2_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (EdeltaGrammarAccess) access;
		match_EdeltaProgram_SemicolonKeyword_2_2_q = new TokenAlias(false, true, grammarAccess.getEdeltaProgramAccess().getSemicolonKeyword_2_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_EdeltaProgram_SemicolonKeyword_2_2_q.equals(syntax))
				emit_EdeltaProgram_SemicolonKeyword_2_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     name=QualifiedName (ambiguity) 'metamodel' metamodels+=[EPackage|STRING]
	 *     name=QualifiedName (ambiguity) (rule end)
	 *     name=QualifiedName (ambiguity) modifyEcoreOperations+=EdeltaModifyEcoreOperation
	 *     name=QualifiedName (ambiguity) operations+=EdeltaOperation
	 *     name=QualifiedName (ambiguity) useAsClauses+=EdeltaUseAs
	 
	 * </pre>
	 */
	protected void emit_EdeltaProgram_SemicolonKeyword_2_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     (rule start) (ambiguity) 'ecoreref' '(' reference=EdeltaEcoreReference
