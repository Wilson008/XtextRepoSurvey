 ...
 */
package edelta.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import edelta.ide.contentassist.antlr.internal.InternalEdeltaParser;
import edelta.services.EdeltaGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class EdeltaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(EdeltaGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EdeltaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEdeltaProgramAccess().getGroup(), "rule__EdeltaProgram__Group__0");
			builder.put(grammarAccess.getEdeltaProgramAccess().getGroup_2(), "rule__EdeltaProgram__Group_2__0");
			builder.put(grammarAccess.getEdeltaProgramAccess().getGroup_3(), "rule__EdeltaProgram__Group_3__0");
			builder.put(grammarAccess.getEdeltaUseAsAccess().getGroup(), "rule__EdeltaUseAs__Group__0");
			builder.put(grammarAccess.getEdeltaModifyEcoreOperationAccess().getGroup(), "rule__EdeltaModifyEcoreOperation__Group__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup(), "rule__EdeltaOperation__Group__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup_2(), "rule__EdeltaOperation__Group_2__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup_2_2(), "rule__EdeltaOperation__Group_2_2__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup_5(), "rule__EdeltaOperation__Group_5__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup_5_1(), "rule__EdeltaOperation__Group_5_1__0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getGroup_7(), "rule__EdeltaOperation__Group_7__0");
			builder.put(grammarAccess.getXPrimaryExpressionAccess().getGroup_0(), "rule__XPrimaryExpression__Group_0__0");
			builder.put(grammarAccess.getEdeltaEcoreReferenceAccess().getGroup(), "rule__EdeltaEcoreReference__Group__0");
			builder.put(grammarAccess.getEdeltaEcoreReferenceAccess().getGroup_1(), "rule__EdeltaEcoreReference__Group_1__0");
			builder.put(grammarAccess.getEdeltaEcoreDirectReferenceAccess().getGroup(), "rule__EdeltaEcoreDirectReference__Group__0");
			...
			builder.put(grammarAccess.getEdeltaProgramAccess().getImportSectionAssignment_1(), "rule__EdeltaProgram__ImportSectionAssignment_1");
			builder.put(grammarAccess.getEdeltaProgramAccess().getNameAssignment_2_1(), "rule__EdeltaProgram__NameAssignment_2_1");
			builder.put(grammarAccess.getEdeltaProgramAccess().getMetamodelsAssignment_3_1(), "rule__EdeltaProgram__MetamodelsAssignment_3_1");
			builder.put(grammarAccess.getEdeltaProgramAccess().getUseAsClausesAssignment_4(), "rule__EdeltaProgram__UseAsClausesAssignment_4");
			builder.put(grammarAccess.getEdeltaProgramAccess().getOperationsAssignment_5(), "rule__EdeltaProgram__OperationsAssignment_5");
			builder.put(grammarAccess.getEdeltaProgramAccess().getModifyEcoreOperationsAssignment_6(), "rule__EdeltaProgram__ModifyEcoreOperationsAssignment_6");
			builder.put(grammarAccess.getEdeltaUseAsAccess().getTypeAssignment_2(), "rule__EdeltaUseAs__TypeAssignment_2");
			builder.put(grammarAccess.getEdeltaUseAsAccess().getExtensionAssignment_4(), "rule__EdeltaUseAs__ExtensionAssignment_4");
			builder.put(grammarAccess.getEdeltaUseAsAccess().getNameAssignment_5(), "rule__EdeltaUseAs__NameAssignment_5");
			builder.put(grammarAccess.getEdeltaModifyEcoreOperationAccess().getNameAssignment_2(), "rule__EdeltaModifyEcoreOperation__NameAssignment_2");
			builder.put(grammarAccess.getEdeltaModifyEcoreOperationAccess().getEpackageAssignment_4(), "rule__EdeltaModifyEcoreOperation__EpackageAssignment_4");
			builder.put(grammarAccess.getEdeltaModifyEcoreOperationAccess().getBodyAssignment_5(), "rule__EdeltaModifyEcoreOperation__BodyAssignment_5");
			builder.put(grammarAccess.getEdeltaOperationAccess().getTypeParametersAssignment_2_1(), "rule__EdeltaOperation__TypeParametersAssignment_2_1");
			builder.put(grammarAccess.getEdeltaOperationAccess().getTypeParametersAssignment_2_2_1(), "rule__EdeltaOperation__TypeParametersAssignment_2_2_1");
			builder.put(grammarAccess.getEdeltaOperationAccess().getNameAssignment_3(), "rule__EdeltaOperation__NameAssignment_3");
			builder.put(grammarAccess.getEdeltaOperationAccess().getParamsAssignment_5_0(), "rule__EdeltaOperation__ParamsAssignment_5_0");
			builder.put(grammarAccess.getEdeltaOperationAccess().getParamsAssignment_5_1_1(), "rule__EdeltaOperation__ParamsAssignment_5_1_1");
			builder.put(grammarAccess.getEdeltaOperationAccess().getTypeAssignment_7_1(), "rule__EdeltaOperation__TypeAssignment_7_1");
			builder.put(grammarAccess.getEdeltaOperationAccess().getBodyAssignment_8(), "rule__EdeltaOperation__BodyAssignment_8");
			builder.put(grammarAccess.getXPrimaryExpressionAccess().getReferenceAssignment_0_3(), "rule__XPrimaryExpression__ReferenceAssignment_0_3");
			builder.put(grammarAccess.getEdeltaEcoreReferenceAccess().getEnamedelementAssignment_1_2(), "rule__EdeltaEcoreReference__EnamedelementAssignment_1_2");
			builder.put(grammarAccess.getEdeltaEcoreDirectReferenceAccess().getEnamedelementAssignment_1(), "rule__EdeltaEcoreDirectReference__EnamedelementAssignment_1");
	...
	@Override
	protected InternalEdeltaParser createParser() {
		InternalEdeltaParser result = new InternalEdeltaParser(null);
