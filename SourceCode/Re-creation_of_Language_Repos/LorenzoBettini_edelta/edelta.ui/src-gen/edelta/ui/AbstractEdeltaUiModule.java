...
import edelta.ide.contentassist.antlr.EdeltaParser;
import edelta.ide.contentassist.antlr.PartialEdeltaContentAssistParser;
import edelta.ide.contentassist.antlr.internal.InternalEdeltaLexer;
import edelta.ui.contentassist.EdeltaProposalProvider;
import edelta.ui.editor.EdeltaEditor;
import edelta.ui.labeling.EdeltaDescriptionLabelProvider;
import edelta.ui.labeling.EdeltaLabelProvider;
import edelta.ui.outline.EdeltaOutlineTreeProvider;
import edelta.ui.quickfix.EdeltaQuickfixProvider;
import edelta.validation.EdeltaValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link EdeltaUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractEdeltaUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractEdeltaUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(edelta.parser.antlr.internal.InternalEdeltaLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalEdeltaLexer.class).toProvider(LexerProvider.create(InternalEdeltaLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return EdeltaValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return EdeltaLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(EdeltaDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return EdeltaOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return EdeltaQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return EdeltaProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialEdeltaContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Edelta Compare");
	}
