 ...
 * <!-- end-user-doc -->
 * @see www.ubx.ch.openAir.OpenAirPackage#getClassType()
 * @model
 * @generated
 */
public enum ClassType implements Enumerator
{
  ...
  /**
   * The '<em><b>TMZ</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #TMZ_VALUE
   * @generated
   ...
   * @ordered
   */
  RESTRICTED(14, "Restricted", "Restricted"),

  /**
   * The '<em><b>UKN</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #UKN_VALUE
   * @generated
   ...
   * @ordered
   */
  public static final int R_VALUE = 8;
   ...
   * @ordered
   */
  public static final int W_VALUE = 9;
   ...
   * @ordered
   */
  public static final int GP_VALUE = 11;

  /**
   * The '<em><b>TMZ</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #TMZ
   * @model
   ...
   * @ordered
   */
  public static final int TMZ_VALUE = 12;
   ...
   * @ordered
   */
  public static final int CTR_VALUE = 13;
   ...
   * @ordered
   */
  public static final int RESTRICTED_VALUE = 14;

  /**
   * The '<em><b>UKN</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #UKN
   * @model
   ...
   * @ordered
   */
  public static final int UKN_VALUE = 15;
