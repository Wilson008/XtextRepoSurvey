...
@Singleton
public class OpenAirGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class OpenAirElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.OpenAir");
	...
	public class AirspaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Airspace");
	...
	public class TheDefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.TheDef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AsClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.AsClass");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SPElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.SP");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SBElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.SB");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AsNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.AsName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LimitesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Limites");
	...
	public class TheGeomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.TheGeom");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class LowLimitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.LowLimit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class HighLimitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.HighLimit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LimitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Limit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.FL");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SFCElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.SFC");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GNDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.GND");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UNLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.UNL");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VALElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.VAL");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.V");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VsubElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Vsub");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class DirElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Dir");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class PlusElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Plus");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MinusElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Minus");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DCElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DC");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RadiusElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Radius");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DPElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DP");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PointElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Point");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class Point1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Point1");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Point2Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Point2");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLongDAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cLongDLongDegrParserRuleCall_0_0 = (RuleCall)cLongDAssignment_0.eContents().get(0);
	...
	public class Point3Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Point3");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLongDAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cLongDLongDegrParserRuleCall_0_0 = (RuleCall)cLongDAssignment_0.eContents().get(0);
		private final Assignment cLongMAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class Point4Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Point4");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLongDAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class LongDegrElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.LongDegr");
	...
	public class LatDegrElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.LatDegr");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cValueINTTerminalRuleCall_0 = (RuleCall)cValueAssignment.eContents().get(0);
	...
	public class MinSecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.MinSec");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SecDecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.SecDec");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cSepParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class MinDecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.MinDec");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cSepParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cValueREALTerminalRuleCall_1_0 = (RuleCall)cValueAssignment_1.eContents().get(0);
	...
	public class LongDecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.LongDec");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class LatDecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.LatDec");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cValueREALTerminalRuleCall_0 = (RuleCall)cValueAssignment.eContents().get(0);
	...
	public class SepElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Sep");
	...
	public class DAElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DA");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DaParamsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DaParams");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DaParams1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DaParams1");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DaParams2Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DaParams2");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cRadiusAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class DBElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.DB");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ATElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.AT");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ClassTypeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.ClassType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class UnitsElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.Units");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class WEElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.WE");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class NSElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.NS");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final OpenAirElements pOpenAir;
	private final AirspaceElements pAirspace;
	private final TheDefElements pTheDef;
	private final AsClassElements pAsClass;
	private final ClassTypeElements eClassType;
	private final SPElements pSP;
	private final SBElements pSB;
	private final AsNameElements pAsName;
	private final LimitesElements pLimites;
	private final TheGeomElements pTheGeom;
	private final LowLimitElements pLowLimit;
	private final HighLimitElements pHighLimit;
	private final LimitElements pLimit;
	private final FLElements pFL;
	private final SFCElements pSFC;
	private final GNDElements pGND;
	private final UNLElements pUNL;
	private final VALElements pVAL;
	private final UnitsElements eUnits;
	private final VElements pV;
	private final VsubElements pVsub;
	private final DirElements pDir;
	private final PlusElements pPlus;
	private final MinusElements pMinus;
	private final DCElements pDC;
	private final RadiusElements pRadius;
	private final DPElements pDP;
	private final PointElements pPoint;
	private final Point1Elements pPoint1;
	private final Point2Elements pPoint2;
	private final Point3Elements pPoint3;
	private final Point4Elements pPoint4;
	private final LongDegrElements pLongDegr;
	private final LatDegrElements pLatDegr;
	private final MinSecElements pMinSec;
	private final SecDecElements pSecDec;
	private final MinDecElements pMinDec;
	private final LongDecElements pLongDec;
	private final LatDecElements pLatDec;
	private final SepElements pSep;
	private final WEElements eWE;
	private final NSElements eNS;
	private final DAElements pDA;
	private final DaParamsElements pDaParams;
	private final DaParams1Elements pDaParams1;
	private final DaParams2Elements pDaParams2;
	...
	public OpenAirGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pOpenAir = new OpenAirElements();
		this.pAirspace = new AirspaceElements();
		this.pTheDef = new TheDefElements();
		this.pAsClass = new AsClassElements();
		this.eClassType = new ClassTypeElements();
		this.pSP = new SPElements();
		this.pSB = new SBElements();
		this.pAsName = new AsNameElements();
		this.pLimites = new LimitesElements();
		this.pTheGeom = new TheGeomElements();
		this.pLowLimit = new LowLimitElements();
		this.pHighLimit = new HighLimitElements();
		this.pLimit = new LimitElements();
		this.pFL = new FLElements();
		this.pSFC = new SFCElements();
		this.pGND = new GNDElements();
		this.pUNL = new UNLElements();
		this.pVAL = new VALElements();
		this.eUnits = new UnitsElements();
		this.pV = new VElements();
		this.pVsub = new VsubElements();
		this.pDir = new DirElements();
		this.pPlus = new PlusElements();
		this.pMinus = new MinusElements();
		this.pDC = new DCElements();
		this.pRadius = new RadiusElements();
		this.pDP = new DPElements();
		this.pPoint = new PointElements();
		this.pPoint1 = new Point1Elements();
		this.pPoint2 = new Point2Elements();
		this.pPoint3 = new Point3Elements();
		this.pPoint4 = new Point4Elements();
		this.pLongDegr = new LongDegrElements();
		this.pLatDegr = new LatDegrElements();
		this.pMinSec = new MinSecElements();
		this.pSecDec = new SecDecElements();
		this.pMinDec = new MinDecElements();
		this.pLongDec = new LongDecElements();
		this.pLatDec = new LatDecElements();
		this.pSep = new SepElements();
		this.eWE = new WEElements();
		this.eNS = new NSElements();
		this.pDA = new DAElements();
		this.pDaParams = new DaParamsElements();
		this.pDaParams1 = new DaParams1Elements();
		this.pDaParams2 = new DaParams2Elements();
		this.pDB = new DBElements();
		this.pAT = new ATElements();
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.INT");
		this.tREAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.REAL");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "www.ubx.ch.OpenAir.SL_COMMENT");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("www.ubx.ch.OpenAir".equals(grammar.getName())) {
				return grammar;
			}
