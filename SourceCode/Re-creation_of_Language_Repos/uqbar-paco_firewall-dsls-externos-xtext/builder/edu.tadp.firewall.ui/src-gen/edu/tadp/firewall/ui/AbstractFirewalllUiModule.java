...
import edu.tadp.firewall.ide.contentassist.antlr.PartialFirewalllContentAssistParser;
import edu.tadp.firewall.ide.contentassist.antlr.internal.InternalFirewalllLexer;
import edu.tadp.firewall.ui.contentassist.FirewalllProposalProvider;
import edu.tadp.firewall.ui.editor.FirewalllEditor;
import edu.tadp.firewall.ui.labeling.FirewalllDescriptionLabelProvider;
import edu.tadp.firewall.ui.labeling.FirewalllLabelProvider;
import edu.tadp.firewall.ui.outline.FirewalllOutlineTreeProvider;
import edu.tadp.firewall.ui.quickfix.FirewalllQuickfixProvider;
import edu.tadp.firewall.validation.FirewalllValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link FirewalllUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractFirewalllUiModule extends DefaultXbaseUiModule {

	public AbstractFirewalllUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(edu.tadp.firewall.parser.antlr.internal.InternalFirewalllLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalFirewalllLexer.class).toProvider(LexerProvider.create(InternalFirewalllLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return FirewalllValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return FirewalllLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(FirewalllDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return FirewalllOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return FirewalllQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return FirewalllProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialFirewalllContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Firewalll Compare");
	}
