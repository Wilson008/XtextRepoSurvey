...
entryRuleAccion returns [String current=null]:
	{ newCompositeNode(grammarAccess.getAccionRule()); }
	iv_ruleAccion=ruleAccion
	{ $current=$iv_ruleAccion.current.getText(); }
	EOF;

// Rule Accion
ruleAccion returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
