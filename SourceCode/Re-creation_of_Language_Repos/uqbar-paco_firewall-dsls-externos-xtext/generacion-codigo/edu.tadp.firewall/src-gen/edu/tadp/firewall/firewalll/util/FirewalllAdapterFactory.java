...
public class FirewalllAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FirewalllSwitch<Adapter> modelSwitch =
    new FirewalllSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseReglaEtiquetada(ReglaEtiquetada object)
      {
        return createReglaEtiquetadaAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseForwardearAccion(ForwardearAccion object)
      {
        return createForwardearAccionAdapter();
      }
      @Override
      public Adapter caseAceptarAccion(AceptarAccion object)
      {
        return createAceptarAccionAdapter();
      }
      @Override
      public Adapter caseBloquearAccion(BloquearAccion object)
      {
        return createBloquearAccionAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.ReglaEtiquetada <em>Regla Etiquetada</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createReglaEtiquetadaAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.Accion <em>Accion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.ForwardearAccion <em>Forwardear Accion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createForwardearAccionAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.AceptarAccion <em>Aceptar Accion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createAceptarAccionAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.BloquearAccion <em>Bloquear Accion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createBloquearAccionAdapter()
  {
    return null;
  }
