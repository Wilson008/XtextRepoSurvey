 ...
 * </p>
 * <ul>
 *   <li>{@link edu.tadp.firewall.firewalll.impl.CondicionPuertoImpl#getPuerto <em>Puerto</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CondicionPuertoImpl extends CondicionImpl implements CondicionPuerto
{
  ...
  public void setPuerto(int newPuerto)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FirewalllPackage.CONDICION_PUERTO__PUERTO, oldPuerto, puerto));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FirewalllPackage.CONDICION_PUERTO__PUERTO:
        return getPuerto();
    }
