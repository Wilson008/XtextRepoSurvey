...
public class FirewalllGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ReglaEtiquetadaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.tadp.firewall.Firewalll.ReglaEtiquetada");
	...
	public class ReglaElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cHayKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cQueKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cAccionAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cAccionAccionParserRuleCall_4_0 = (RuleCall)cAccionAssignment_4.eContents().get(0);
		...
		//'hay'
		public Keyword getHayKeyword_2() { return cHayKeyword_2; }
		
		//'que'
		public Keyword getQueKeyword_3() { return cQueKeyword_3; }
		
		//accion=Accion
		public Assignment getAccionAssignment_4() { return cAccionAssignment_4; }
		
		//Accion
		public RuleCall getAccionAccionParserRuleCall_4_0() { return cAccionAccionParserRuleCall_4_0; }
	...
	public class ForwardearAccionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.tadp.firewall.Firewalll.ForwardearAccion");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AceptarAccionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.tadp.firewall.Firewalll.AceptarAccion");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BloquearAccionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.tadp.firewall.Firewalll.BloquearAccion");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final ReglaEtiquetadaElements pReglaEtiquetada;
	private final ReglaElements pRegla;
	private final AccionElements pAccion;
	private final ForwardearAccionElements pForwardearAccion;
	private final AceptarAccionElements pAceptarAccion;
	private final BloquearAccionElements pBloquearAccion;
	...
	public FirewalllGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pReglaEtiquetada = new ReglaEtiquetadaElements();
		this.pRegla = new ReglaElements();
		this.pAccion = new AccionElements();
		this.pForwardearAccion = new ForwardearAccionElements();
		this.pAceptarAccion = new AceptarAccionElements();
		this.pBloquearAccion = new BloquearAccionElements();
