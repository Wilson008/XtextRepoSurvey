...
/**
 * This is the item provider adapter for a {@link nowheretravel.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NowheretravelPackage.Literals.NODE__OUTGOING_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NowheretravelPackage.Literals.NODE__INGOING_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
