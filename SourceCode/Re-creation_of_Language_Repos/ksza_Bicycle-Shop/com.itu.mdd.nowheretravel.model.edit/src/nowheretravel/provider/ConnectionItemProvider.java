...
/**
 * This is the item provider adapter for a {@link nowheretravel.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NowheretravelPackage.Literals.CONNECTION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSourceNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_sourceNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_sourceNode_feature", "_UI_Connection_type"),
				 NowheretravelPackage.Literals.CONNECTION__SOURCE_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_targetNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_targetNode_feature", "_UI_Connection_type"),
				 NowheretravelPackage.Literals.CONNECTION__TARGET_NODE,
				 true,
				 false,
				 true,
				 null,
