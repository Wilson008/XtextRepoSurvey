...
import org.xtext.example.rmodp.ide.contentassist.antlr.PartialRmOdpContentAssistParser;
import org.xtext.example.rmodp.ide.contentassist.antlr.RmOdpParser;
import org.xtext.example.rmodp.ide.contentassist.antlr.internal.InternalRmOdpLexer;
import org.xtext.example.rmodp.ui.contentassist.RmOdpProposalProvider;
import org.xtext.example.rmodp.ui.editor.RmOdpEditor;
import org.xtext.example.rmodp.ui.labeling.RmOdpDescriptionLabelProvider;
import org.xtext.example.rmodp.ui.labeling.RmOdpLabelProvider;
import org.xtext.example.rmodp.ui.outline.RmOdpOutlineTreeProvider;
import org.xtext.example.rmodp.ui.quickfix.RmOdpQuickfixProvider;
import org.xtext.example.rmodp.validation.RmOdpValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link RmOdpUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractRmOdpUiModule extends DefaultXbaseUiModule {

	public AbstractRmOdpUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.example.rmodp.parser.antlr.internal.InternalRmOdpLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return RmOdpParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalRmOdpLexer.class).toProvider(LexerProvider.create(InternalRmOdpLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return RmOdpValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return RmOdpLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(RmOdpDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return RmOdpOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return RmOdpQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return RmOdpProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialRmOdpContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("RmOdp Compare");
	}
