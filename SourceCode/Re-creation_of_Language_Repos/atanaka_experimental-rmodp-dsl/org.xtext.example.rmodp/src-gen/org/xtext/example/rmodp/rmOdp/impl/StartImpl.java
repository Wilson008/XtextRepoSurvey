 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.rmodp.rmOdp.impl.StartImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartImpl extends NodeImpl implements Start
{
  ...
  {
    return RmOdpPackage.Literals.START;
  }
  ...
  public EList<Node> getOutgoing()
  {
    if (outgoing == null)
    {
      outgoing = new EObjectResolvingEList<Node>(Node.class, this, RmOdpPackage.START__OUTGOING);
    }
    return outgoing;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RmOdpPackage.START__OUTGOING:
        return getOutgoing();
    }
