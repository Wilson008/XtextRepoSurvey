		...
		(
			...
			lv_elements_0_0=ruleModelElement
			{
				...
				add(
					...
					"elements",
					lv_elements_0_0,
					"org.xtext.example.rmodp.RmOdp.ModelElement");
				...
				(
					...
					lv_properties_5_0=ruleProperty
					{
						...
						add(
							...
							"properties",
							lv_properties_5_0,
							"org.xtext.example.rmodp.RmOdp.Property");
						afterParserOrEnumRuleCall();
					}
				)
			)*
...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getImportAccess().getImportedNamespaceQualifiedNameWithWildCard_1ParserRuleCall_1_0());
				}
				lv_importedNamespace_1_0=ruleQualifiedNameWithWildCard_1
				{
					if ($current==null) {
					...
					set(
						...
						"org.xtext.example.rmodp.RmOdp.QualifiedNameWithWildCard_1");
					afterParserOrEnumRuleCall();
				}
			)
		)
...
entryRuleQualifiedNameWithWildCard_1 returns [String current=null]:
	{ newCompositeNode(grammarAccess.getQualifiedNameWithWildCard_1Rule()); }
	iv_ruleQualifiedNameWithWildCard_1=ruleQualifiedNameWithWildCard_1
	{ $current=$iv_ruleQualifiedNameWithWildCard_1.current.getText(); }
	EOF;

// Rule QualifiedNameWithWildCard_1
ruleQualifiedNameWithWildCard_1 returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getQualifiedNameWithWildCard_1Access().getQualifiedNameParserRuleCall_0());
		}
		...
		(
			...
			{
				$current.merge(kw);
				newLeafNode(kw, grammarAccess.getQualifiedNameWithWildCard_1Access().getFullStopKeyword_1_0());
			}
			kw='*'
			{
				$current.merge(kw);
				newLeafNode(kw, grammarAccess.getQualifiedNameWithWildCard_1Access().getAsteriskKeyword_1_1());
			}
		)?
	)
;
				...
				(
					...
					lv_stateMachine_7_0=ruleStateMachine
					{
						...
						set(
							...
							"stateMachine",
							lv_stateMachine_7_0,
							"org.xtext.example.rmodp.RmOdp.StateMachine");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_interfaces_9_0=ruleInterface
				{
					...
					add(
						...
						"interfaces",
						lv_interfaces_9_0,
						"org.xtext.example.rmodp.RmOdp.Interface");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_innerObjects_11_0=ruleObject
					{
						...
						add(
							...
							"org.xtext.example.rmodp.RmOdp.Object");
						afterParserOrEnumRuleCall();
					}
				)
			)+
		...
		(
			(
				...
				}
				{
					...
					setWithLastConsumed($current, "many", lv_many_4_0 != null, "[]");
				}
			)
		)?
	)
			...
			(
				...
				lv_events_1_0=ruleEvent
				{
					...
					add(
						...
						"events",
						lv_events_1_0,
						"org.xtext.example.rmodp.RmOdp.Event");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_commands_4_0=ruleCommand
				{
					...
					add(
						...
						"commands",
						lv_commands_4_0,
						"org.xtext.example.rmodp.RmOdp.Command");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_states_6_0=ruleState
				{
					...
					add(
						...
						"states",
						lv_states_6_0,
						"org.xtext.example.rmodp.RmOdp.State");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_stateTransitions_6_0=ruleStateTransition
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.StateTransition");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_signatureReferences_3_0=ruleSignatureReference
					{
						...
						add(
							...
							"org.xtext.example.rmodp.RmOdp.SignatureReference");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_params_3_0=ruleParam
				{
					...
					add(
						...
						"params",
						lv_params_3_0,
						"org.xtext.example.rmodp.RmOdp.Param");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_foa_3_0=ruleFieldOfApplication
				{
					...
					set(
						...
						"foa",
						lv_foa_3_0,
						"org.xtext.example.rmodp.RmOdp.FieldOfApplication");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_communityContracts_5_0=ruleCommunityContract
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.CommunityContract");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_objective_3_0=ruleObjective
				{
					...
					set(
						...
						"objective",
						lv_objective_3_0,
						"org.xtext.example.rmodp.RmOdp.Objective");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_community_4_0=ruleCommunity
				{
					...
					set(
						...
						"community",
						lv_community_4_0,
						"org.xtext.example.rmodp.RmOdp.Community");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_roles_4_0=ruleRole
				{
					...
					add(
						...
						"roles",
						lv_roles_4_0,
						"org.xtext.example.rmodp.RmOdp.Role");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_or_relations_5_0=ruleOR_Relation
				{
					...
					add(
						...
						"or_relations",
						lv_or_relations_5_0,
						"org.xtext.example.rmodp.RmOdp.OR_Relation");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_processes_6_0=ruleProcess
				{
					...
					add(
						...
						"processes",
						lv_processes_6_0,
						"org.xtext.example.rmodp.RmOdp.Process");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_interactions_7_0=ruleInteraction
				{
					...
					add(
						...
						"interactions",
						lv_interactions_7_0,
						"org.xtext.example.rmodp.RmOdp.Interaction");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_policies_8_0=rulePolicy
				{
					...
					add(
						...
						"policies",
						lv_policies_8_0,
						"org.xtext.example.rmodp.RmOdp.Policy");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_lanes_5_0=ruleLane
					{
						...
						add(
							...
							"lanes",
							lv_lanes_5_0,
							"org.xtext.example.rmodp.RmOdp.Lane");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_nodes_3_0=ruleNode
				{
					...
					add(
						...
						"nodes",
						lv_nodes_3_0,
						"org.xtext.example.rmodp.RmOdp.Node");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_incomings_3_0=ruleIncoming
				{
					...
					add(
						...
						"incomings",
						lv_incomings_3_0,
						"org.xtext.example.rmodp.RmOdp.Incoming");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_outgoings_4_0=ruleOutgoing
				{
					...
					add(
						...
						"outgoings",
						lv_outgoings_4_0,
						"org.xtext.example.rmodp.RmOdp.Outgoing");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_interactionArtefacts_15_0=ruleInteractionArtefact
					{
						...
						add(
							...
							"org.xtext.example.rmodp.RmOdp.InteractionArtefact");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_obligations_6_0=ruleObjectObligation
				{
					...
					add(
						...
						"obligations",
						lv_obligations_6_0,
						"org.xtext.example.rmodp.RmOdp.ObjectObligation");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_obligations_7_0=ruleRoleObligation
				{
					...
					add(
						...
						"obligations",
						lv_obligations_7_0,
						"org.xtext.example.rmodp.RmOdp.RoleObligation");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_permissions_8_0=ruleObjectPermission
				{
					...
					add(
						...
						"permissions",
						lv_permissions_8_0,
						"org.xtext.example.rmodp.RmOdp.ObjectPermission");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_permissions_9_0=ruleRolePermission
				{
					...
					add(
						...
						"permissions",
						lv_permissions_9_0,
						"org.xtext.example.rmodp.RmOdp.RolePermission");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_prohibitions_10_0=ruleObjectProhibition
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.ObjectProhibition");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_prohibitions_11_0=ruleRoleProhibition
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.RoleProhibition");
					afterParserOrEnumRuleCall();
				}
			)
		)*
		...
		(
			(
				...
				}
				{
					...
					setWithLastConsumed($current, "inforce", lv_inforce_3_0 != null, "current");
				}
			)
		)?
		otherlv_4='EV_Object'
			...
			(
				...
				lv_invariantSchema_3_0=ruleInvariantSchema
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.InvariantSchema");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_dynamicSchema_4_0=ruleDynamicSchema
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.DynamicSchema");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_staticSchema_5_0=ruleStaticSchema
				{
					...
					add(
						...
						"staticSchema",
						lv_staticSchema_5_0,
						"org.xtext.example.rmodp.RmOdp.StaticSchema");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_actionTypes_4_0=ruleActionType
				{
					...
					add(
						...
						"actionTypes",
						lv_actionTypes_4_0,
						"org.xtext.example.rmodp.RmOdp.ActionType");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_objectInstances_6_0=ruleObjectInstance
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.ObjectInstance");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_propertyInstances_4_0=rulePropertyInstance
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.PropertyInstance");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_actionTypes_3_0=ruleActionProperty
				{
					...
					add(
						...
						"actionTypes",
						lv_actionTypes_3_0,
						"org.xtext.example.rmodp.RmOdp.ActionProperty");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_cdatatypes_3_0=ruleType
				{
					...
					add(
						...
						"cdatatypes",
						lv_cdatatypes_3_0,
						"org.xtext.example.rmodp.RmOdp.Type");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_signatureDefs_4_0=ruleSignatureDef
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.SignatureDef");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_hostNode_3_0=ruleHostNode
				{
					...
					add(
						...
						"hostNode",
						lv_hostNode_3_0,
						"org.xtext.example.rmodp.RmOdp.HostNode");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_link_3_0=ruleLink
				{
					...
					add(
						...
						"link",
						lv_link_3_0,
						"org.xtext.example.rmodp.RmOdp.Link");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_implementableStandards_4_0=ruleImplementableStandard
				{
					...
					add(
						...
						"org.xtext.example.rmodp.RmOdp.ImplementableStandard");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_ixits_5_0=ruleIXIT
				{
					...
					add(
						...
						"ixits",
						lv_ixits_5_0,
						"org.xtext.example.rmodp.RmOdp.IXIT");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_endpoints1_6_0=ruleEndPoint
				{
					...
					add(
						...
						"endpoints1",
						lv_endpoints1_6_0,
						"org.xtext.example.rmodp.RmOdp.EndPoint");
					afterParserOrEnumRuleCall();
				}
			)
		)*
