 ...
 * </p>
 * <ul>
 *   <li>{@link de.sebastianbenz.xgherkin.gherkin.impl.ScenarioImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioImpl extends AbstractScenarioImpl implements Scenario
{
  ...
  public EList<NarrativeElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<NarrativeElement>(NarrativeElement.class, this, GherkinPackage.SCENARIO__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GherkinPackage.SCENARIO__ELEMENTS:
