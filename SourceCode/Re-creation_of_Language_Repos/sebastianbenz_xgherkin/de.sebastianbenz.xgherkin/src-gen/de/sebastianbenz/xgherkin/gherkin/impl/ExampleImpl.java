 ...
 * </p>
 * <ul>
 *   <li>{@link de.sebastianbenz.xgherkin.gherkin.impl.ExampleImpl#getHeading <em>Heading</em>}</li>
 *   <li>{@link de.sebastianbenz.xgherkin.gherkin.impl.ExampleImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExampleImpl extends MinimalEObjectImpl.Container implements Example
{
  ...
  public NotificationChain basicSetHeading(ExampleRow newHeading, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GherkinPackage.EXAMPLE__HEADING, oldHeading, newHeading);
  ...
  public void setHeading(ExampleRow newHeading)
  {
    if (newHeading != heading)
    {
      ...
      if (heading != null)
        msgs = ((InternalEObject)heading).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GherkinPackage.EXAMPLE__HEADING, null, msgs);
      if (newHeading != null)
        msgs = ((InternalEObject)newHeading).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GherkinPackage.EXAMPLE__HEADING, null, msgs);
      msgs = basicSetHeading(newHeading, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GherkinPackage.EXAMPLE__HEADING, newHeading, newHeading));
  }
  ...
  public EList<ExampleRow> getRows()
  {
    if (rows == null)
    {
      rows = new EObjectContainmentEList<ExampleRow>(ExampleRow.class, this, GherkinPackage.EXAMPLE__ROWS);
    }
    return rows;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GherkinPackage.EXAMPLE__HEADING:
        return basicSetHeading(null, msgs);
      case GherkinPackage.EXAMPLE__ROWS:
