...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UNG Segment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getAddressUsage <em>Address Usage</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getAddressDetails <em>Address Details</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getCityName <em>City Name</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getPostalIdentificationCode <em>Postal Identification Code</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getCountryNameCode <em>Country Name Code</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getCountrySubEntityDetails <em>Country Sub Entity Details</em>}</li>
 *   <li>{@link io.thlaegler.edifact.edilang.impl.UNGSegmentImpl#getLocationIdentification <em>Location Identification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UNGSegmentImpl extends AbstractEdiSegmentImpl implements UNGSegment
{
  /**
  ...
  {
    return EdilangPackage.eINSTANCE.getUNGSegment();
  }
  ...
  public NotificationChain basicSetAddressUsage(AddressUsage newAddressUsage, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__ADDRESS_USAGE, oldAddressUsage, newAddressUsage);
  ...
  public void setAddressUsage(AddressUsage newAddressUsage)
  {
    if (newAddressUsage != addressUsage)
    {
      ...
      if (addressUsage != null)
        msgs = ((InternalEObject)addressUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__ADDRESS_USAGE, null, msgs);
      if (newAddressUsage != null)
        msgs = ((InternalEObject)newAddressUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__ADDRESS_USAGE, null, msgs);
      msgs = basicSetAddressUsage(newAddressUsage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__ADDRESS_USAGE, newAddressUsage, newAddressUsage));
  }
  ...
  public NotificationChain basicSetAddressDetails(AddressDetail newAddressDetails, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__ADDRESS_DETAILS, oldAddressDetails, newAddressDetails);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAddressDetails(AddressDetail newAddressDetails)
  {
    if (newAddressDetails != addressDetails)
    {
      ...
      if (addressDetails != null)
        msgs = ((InternalEObject)addressDetails).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__ADDRESS_DETAILS, null, msgs);
      if (newAddressDetails != null)
        msgs = ((InternalEObject)newAddressDetails).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__ADDRESS_DETAILS, null, msgs);
      msgs = basicSetAddressDetails(newAddressDetails, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__ADDRESS_DETAILS, newAddressDetails, newAddressDetails));
  }
  ...
  public void setCityName(String newCityName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__CITY_NAME, oldCityName, cityName));
  }
  ...
  public void setPostalIdentificationCode(String newPostalIdentificationCode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__POSTAL_IDENTIFICATION_CODE, oldPostalIdentificationCode, postalIdentificationCode));
  }
  ...
  public void setCountryNameCode(String newCountryNameCode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__COUNTRY_NAME_CODE, oldCountryNameCode, countryNameCode));
  }
  ...
  public NotificationChain basicSetCountrySubEntityDetails(CountrySubEntityDetail newCountrySubEntityDetails, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__COUNTRY_SUB_ENTITY_DETAILS, oldCountrySubEntityDetails, newCountrySubEntityDetails);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCountrySubEntityDetails(CountrySubEntityDetail newCountrySubEntityDetails)
  {
    if (newCountrySubEntityDetails != countrySubEntityDetails)
    {
      ...
      if (countrySubEntityDetails != null)
        msgs = ((InternalEObject)countrySubEntityDetails).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__COUNTRY_SUB_ENTITY_DETAILS, null, msgs);
      if (newCountrySubEntityDetails != null)
        msgs = ((InternalEObject)newCountrySubEntityDetails).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__COUNTRY_SUB_ENTITY_DETAILS, null, msgs);
      msgs = basicSetCountrySubEntityDetails(newCountrySubEntityDetails, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__COUNTRY_SUB_ENTITY_DETAILS, newCountrySubEntityDetails, newCountrySubEntityDetails));
  }
  ...
  public NotificationChain basicSetLocationIdentification(LocationIdentification newLocationIdentification, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__LOCATION_IDENTIFICATION, oldLocationIdentification, newLocationIdentification);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLocationIdentification(LocationIdentification newLocationIdentification)
  {
    if (newLocationIdentification != locationIdentification)
    {
      ...
      if (locationIdentification != null)
        msgs = ((InternalEObject)locationIdentification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__LOCATION_IDENTIFICATION, null, msgs);
      if (newLocationIdentification != null)
        msgs = ((InternalEObject)newLocationIdentification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdilangPackage.UNG_SEGMENT__LOCATION_IDENTIFICATION, null, msgs);
      msgs = basicSetLocationIdentification(newLocationIdentification, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdilangPackage.UNG_SEGMENT__LOCATION_IDENTIFICATION, newLocationIdentification, newLocationIdentification));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EdilangPackage.UNG_SEGMENT__ADDRESS_USAGE:
        return basicSetAddressUsage(null, msgs);
      case EdilangPackage.UNG_SEGMENT__ADDRESS_DETAILS:
        return basicSetAddressDetails(null, msgs);
      case EdilangPackage.UNG_SEGMENT__COUNTRY_SUB_ENTITY_DETAILS:
        return basicSetCountrySubEntityDetails(null, msgs);
      case EdilangPackage.UNG_SEGMENT__LOCATION_IDENTIFICATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EdilangPackage.UNG_SEGMENT__CITY_NAME:
        return getCityName();
      case EdilangPackage.UNG_SEGMENT__POSTAL_IDENTIFICATION_CODE:
        return getPostalIdentificationCode();
      case EdilangPackage.UNG_SEGMENT__COUNTRY_NAME_CODE:
