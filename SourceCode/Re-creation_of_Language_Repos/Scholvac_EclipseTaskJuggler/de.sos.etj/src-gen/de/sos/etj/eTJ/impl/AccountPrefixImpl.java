 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.impl.AccountPrefixImpl#getAccount <em>Account</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccountPrefixImpl extends IncludePropertiesAttributeImpl implements AccountPrefix
{
  ...
  {
    return ETJPackage.eINSTANCE.getAccountPrefix();
  }
    ...
    if (account != null && account.eIsProxy())
    {
      ...
      if (account != oldAccount)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ETJPackage.ACCOUNT_PREFIX__ACCOUNT, oldAccount, account));
      }
    }
    return account;
  }
  ...
  public void setAccount(Account newAccount)
  {
    ...
    account = newAccount;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.ACCOUNT_PREFIX__ACCOUNT, oldAccount, account));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ETJPackage.ACCOUNT_PREFIX__ACCOUNT:
