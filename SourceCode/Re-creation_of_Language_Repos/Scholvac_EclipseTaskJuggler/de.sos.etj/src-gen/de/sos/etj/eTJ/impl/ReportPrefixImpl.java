 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.impl.ReportPrefixImpl#getReport <em>Report</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportPrefixImpl extends IncludePropertiesAttributeImpl implements ReportPrefix
{
  ...
  {
    return ETJPackage.eINSTANCE.getReportPrefix();
  }
    ...
    if (report != null && report.eIsProxy())
    {
      ...
      if (report != oldReport)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ETJPackage.REPORT_PREFIX__REPORT, oldReport, report));
      }
    }
    return report;
  }
  ...
  public void setReport(Report newReport)
  {
    ...
    report = newReport;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.REPORT_PREFIX__REPORT, oldReport, report));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ETJPackage.REPORT_PREFIX__REPORT:
