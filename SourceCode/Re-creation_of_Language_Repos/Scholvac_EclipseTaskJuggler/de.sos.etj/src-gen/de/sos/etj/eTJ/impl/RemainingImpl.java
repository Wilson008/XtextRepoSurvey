 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.impl.RemainingImpl#getRemaining <em>Remaining</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemainingImpl extends NewTaskAttributeImpl implements Remaining
{
  ...
  {
    return ETJPackage.eINSTANCE.getRemaining();
  }
  ...
  public NotificationChain basicSetRemaining(DurationQuantity newRemaining, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ETJPackage.REMAINING__REMAINING, oldRemaining, newRemaining);
  ...
  public void setRemaining(DurationQuantity newRemaining)
  {
    if (newRemaining != remaining)
    {
      ...
      if (remaining != null)
        msgs = ((InternalEObject)remaining).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ETJPackage.REMAINING__REMAINING, null, msgs);
      if (newRemaining != null)
        msgs = ((InternalEObject)newRemaining).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ETJPackage.REMAINING__REMAINING, null, msgs);
      msgs = basicSetRemaining(newRemaining, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.REMAINING__REMAINING, newRemaining, newRemaining));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ETJPackage.REMAINING__REMAINING:
