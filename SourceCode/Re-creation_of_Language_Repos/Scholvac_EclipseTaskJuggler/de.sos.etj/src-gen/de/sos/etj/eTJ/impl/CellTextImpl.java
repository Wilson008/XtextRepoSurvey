 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.impl.CellTextImpl#getExpresssion <em>Expresssion</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.impl.CellTextImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellTextImpl extends ColumnAttributeImpl implements CellText
{
  ...
  {
    return ETJPackage.eINSTANCE.getCellText();
  }
  ...
  public NotificationChain basicSetExpresssion(LogicalExpression newExpresssion, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ETJPackage.CELL_TEXT__EXPRESSSION, oldExpresssion, newExpresssion);
  ...
  public void setExpresssion(LogicalExpression newExpresssion)
  {
    if (newExpresssion != expresssion)
    {
      ...
      if (expresssion != null)
        msgs = ((InternalEObject)expresssion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ETJPackage.CELL_TEXT__EXPRESSSION, null, msgs);
      if (newExpresssion != null)
        msgs = ((InternalEObject)newExpresssion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ETJPackage.CELL_TEXT__EXPRESSSION, null, msgs);
      msgs = basicSetExpresssion(newExpresssion, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.CELL_TEXT__EXPRESSSION, newExpresssion, newExpresssion));
  }
  ...
  public void setText(String newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.CELL_TEXT__TEXT, oldText, text));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ETJPackage.CELL_TEXT__EXPRESSSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ETJPackage.CELL_TEXT__TEXT:
        return getText();
    }
