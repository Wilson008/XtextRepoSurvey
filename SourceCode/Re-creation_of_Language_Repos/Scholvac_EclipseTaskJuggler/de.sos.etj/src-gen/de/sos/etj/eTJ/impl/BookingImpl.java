 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.impl.BookingImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.impl.BookingImpl#getOvertime <em>Overtime</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.impl.BookingImpl#getSloppy <em>Sloppy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking
{
  ...
  {
    return ETJPackage.eINSTANCE.getBooking();
  }
  ...
  public NotificationChain basicSetInterval(Interval4 newInterval, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ETJPackage.BOOKING__INTERVAL, oldInterval, newInterval);
  ...
  public void setInterval(Interval4 newInterval)
  {
    if (newInterval != interval)
    {
      ...
      if (interval != null)
        msgs = ((InternalEObject)interval).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ETJPackage.BOOKING__INTERVAL, null, msgs);
      if (newInterval != null)
        msgs = ((InternalEObject)newInterval).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ETJPackage.BOOKING__INTERVAL, null, msgs);
      msgs = basicSetInterval(newInterval, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.BOOKING__INTERVAL, newInterval, newInterval));
  }
  ...
  public void setOvertime(int newOvertime)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.BOOKING__OVERTIME, oldOvertime, overtime));
  }
  ...
  public void setSloppy(int newSloppy)
  {
    ...
    sloppy = newSloppy;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ETJPackage.BOOKING__SLOPPY, oldSloppy, sloppy));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ETJPackage.BOOKING__INTERVAL:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ETJPackage.BOOKING__INTERVAL:
        return getInterval();
      case ETJPackage.BOOKING__OVERTIME:
        return getOvertime();
      case ETJPackage.BOOKING__SLOPPY:
        return getSloppy();
    }
