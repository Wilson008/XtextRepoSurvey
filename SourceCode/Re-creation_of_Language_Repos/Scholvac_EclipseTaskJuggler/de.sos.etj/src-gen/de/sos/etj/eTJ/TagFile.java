 ...
 * </p>
 * <ul>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getId <em>Id</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getFilename <em>Filename</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getHideResource <em>Hide Resource</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getHideTask <em>Hide Task</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getRollupResource <em>Rollup Resource</em>}</li>
 *   <li>{@link de.sos.etj.eTJ.TagFile#getRollupTask <em>Rollup Task</em>}</li>
 * </ul>
 *
 * @see de.sos.etj.eTJ.ETJPackage#getTagFile()
 * @model
 * @generated
 */
public interface TagFile extends Property
{
   ...
   * @see #setId(String)
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_Filename()
   * @model
   * @generated
   */
  String getFilename();
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getFilename <em>Filename</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_HideResource()
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getHideResource <em>Hide Resource</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_HideTask()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getHideTask <em>Hide Task</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_RollupResource()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getRollupResource <em>Rollup Resource</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.sos.etj.eTJ.ETJPackage#getTagFile_RollupTask()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.sos.etj.eTJ.TagFile#getRollupTask <em>Rollup Task</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
