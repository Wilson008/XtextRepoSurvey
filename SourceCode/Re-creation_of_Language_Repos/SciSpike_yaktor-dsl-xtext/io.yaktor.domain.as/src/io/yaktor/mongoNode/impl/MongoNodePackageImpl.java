...
public class MongoNodePackageImpl extends EPackageImpl implements MongoNodePackage {
	...
	public static MongoNodePackage init() {
		...
		Object registeredMongoNodePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MongoNodePackageImpl theMongoNodePackage = registeredMongoNodePackage instanceof MongoNodePackageImpl ? (MongoNodePackageImpl)registeredMongoNodePackage : new MongoNodePackageImpl();
