...
/**
 * This is the item provider adapter for a {@link io.yaktor.domain.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.FIELD__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_cardinality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_cardinality_feature", "_UI_Field_type"),
				 DomainPackage.Literals.FIELD__CARDINALITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
