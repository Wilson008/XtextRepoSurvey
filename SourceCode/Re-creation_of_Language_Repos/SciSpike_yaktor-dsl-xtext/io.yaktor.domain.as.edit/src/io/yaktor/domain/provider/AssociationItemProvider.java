...
/**
 * This is the item provider adapter for a {@link io.yaktor.domain.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider extends NamedTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_isUnidirectional_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_isUnidirectional_feature", "_UI_Association_type"),
				 DomainPackage.Literals.ASSOCIATION__IS_UNIDIRECTIONAL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.ASSOCIATION__START);
			childrenFeatures.add(DomainPackage.Literals.ASSOCIATION__END);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.ASSOCIATION__START,
				 DomainFactory.eINSTANCE.createAssociationEnd()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.ASSOCIATION__END,
				 DomainFactory.eINSTANCE.createAssociationEnd()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.ASSOCIATION__START ||
			childFeature == DomainPackage.Literals.ASSOCIATION__END;
