...
/**
 * This is the item provider adapter for a {@link io.yaktor.domain.AssociationEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationEndItemProvider extends ConstraintTypeFieldItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssociationEnd_isComposition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssociationEnd_isComposition_feature", "_UI_AssociationEnd_type"),
				 DomainPackage.Literals.ASSOCIATION_END__IS_COMPOSITION,
				 true,
				 false,
				 false,
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssociationEnd_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssociationEnd_references_feature", "_UI_AssociationEnd_type"),
				 DomainPackage.Literals.ASSOCIATION_END__REFERENCES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.ASSOCIATION_END__UNIQUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
