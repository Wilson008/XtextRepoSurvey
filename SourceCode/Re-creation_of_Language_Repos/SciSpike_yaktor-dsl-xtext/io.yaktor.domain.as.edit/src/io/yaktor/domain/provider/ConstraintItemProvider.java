...
/**
 * This is the item provider adapter for a {@link io.yaktor.domain.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_fields_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_fields_feature", "_UI_Constraint_type"),
				 DomainPackage.Literals.CONSTRAINT__FIELDS,
				 true,
				 false,
				 true,
				 null,
