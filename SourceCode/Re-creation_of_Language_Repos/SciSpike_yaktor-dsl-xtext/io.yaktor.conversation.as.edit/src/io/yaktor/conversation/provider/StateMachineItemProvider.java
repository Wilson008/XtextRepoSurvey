...
/**
 * This is the item provider adapter for a {@link io.yaktor.conversation.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConversationPackage.Literals.STATE_MACHINE__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConversationPackage.Literals.STATE_MACHINE__STATES);
			childrenFeatures.add(ConversationPackage.Literals.STATE_MACHINE__INITIAL_TRANSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConversationPackage.Literals.STATE_MACHINE__STATES,
				 ConversationFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(ConversationPackage.Literals.STATE_MACHINE__STATES,
				 ConversationFactory.eINSTANCE.createDecision()));

		newChildDescriptors.add
			(createChildParameter
				(ConversationPackage.Literals.STATE_MACHINE__STATES,
				 ConversationFactory.eINSTANCE.createJoin()));

		newChildDescriptors.add
			(createChildParameter
				(ConversationPackage.Literals.STATE_MACHINE__INITIAL_TRANSITION,
