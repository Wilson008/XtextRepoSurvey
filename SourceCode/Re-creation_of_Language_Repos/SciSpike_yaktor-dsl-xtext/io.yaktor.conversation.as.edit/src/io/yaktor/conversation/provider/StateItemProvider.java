...
/**
 * This is the item provider adapter for a {@link io.yaktor.conversation.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConversationPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRequiresExecutionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_requiresExecution_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_requiresExecution_feature", "_UI_State_type"),
				 ConversationPackage.Literals.STATE__REQUIRES_EXECUTION,
				 true,
				 false,
				 false,
	...
	protected void addJoinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_join_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_join_feature", "_UI_State_type"),
				 ConversationPackage.Literals.STATE__JOIN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConversationPackage.Literals.STATE__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConversationPackage.Literals.STATE__TRANSITIONS,
				 ConversationFactory.eINSTANCE.createTransition()));
	}
