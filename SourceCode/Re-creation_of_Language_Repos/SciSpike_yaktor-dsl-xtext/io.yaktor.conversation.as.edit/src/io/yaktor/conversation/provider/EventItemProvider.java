...
/**
 * This is the item provider adapter for a {@link io.yaktor.conversation.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConversationPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRefTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_refType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_refType_feature", "_UI_Event_type"),
				 ConversationPackage.Literals.EVENT__REF_TYPE,
				 true,
				 false,
				 true,
				 null,
