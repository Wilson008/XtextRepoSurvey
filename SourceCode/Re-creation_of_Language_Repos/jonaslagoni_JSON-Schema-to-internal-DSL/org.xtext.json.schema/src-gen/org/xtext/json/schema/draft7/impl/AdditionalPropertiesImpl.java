 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.json.schema.draft7.impl.AdditionalPropertiesImpl#getAllowedBoolean <em>Allowed Boolean</em>}</li>
 *   <li>{@link org.xtext.json.schema.draft7.impl.AdditionalPropertiesImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalPropertiesImpl extends MinimalEObjectImpl.Container implements AdditionalProperties
{
  /**
  ...
  {
    return Draft7Package.Literals.ADDITIONAL_PROPERTIES;
  }
  ...
  public void setAllowedBoolean(org.xtext.json.schema.draft7.Boolean newAllowedBoolean)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Draft7Package.ADDITIONAL_PROPERTIES__ALLOWED_BOOLEAN, oldAllowedBoolean, allowedBoolean));
  }
  ...
  public NotificationChain basicSetSchema(AbstractSchema newSchema, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Draft7Package.ADDITIONAL_PROPERTIES__SCHEMA, oldSchema, newSchema);
  ...
  public void setSchema(AbstractSchema newSchema)
  {
    if (newSchema != schema)
    {
      ...
      if (schema != null)
        msgs = ((InternalEObject)schema).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Draft7Package.ADDITIONAL_PROPERTIES__SCHEMA, null, msgs);
      if (newSchema != null)
        msgs = ((InternalEObject)newSchema).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Draft7Package.ADDITIONAL_PROPERTIES__SCHEMA, null, msgs);
      msgs = basicSetSchema(newSchema, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Draft7Package.ADDITIONAL_PROPERTIES__SCHEMA, newSchema, newSchema));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Draft7Package.ADDITIONAL_PROPERTIES__SCHEMA:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Draft7Package.ADDITIONAL_PROPERTIES__ALLOWED_BOOLEAN:
