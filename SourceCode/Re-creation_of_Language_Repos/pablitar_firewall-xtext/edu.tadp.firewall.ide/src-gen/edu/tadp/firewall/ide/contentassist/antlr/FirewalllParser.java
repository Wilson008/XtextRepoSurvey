...
public class FirewalllParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FirewalllGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAccionAccess().getGroup_0(), "rule__Accion__Group_0__0");
			builder.put(grammarAccess.getAccionAccess().getGroup_1(), "rule__Accion__Group_1__0");
			builder.put(grammarAccess.getAccionAccess().getGroup_2(), "rule__Accion__Group_2__0");
			...
			builder.put(grammarAccess.getReglaAccess().getAccionAssignment_3(), "rule__Regla__AccionAssignment_3");
			builder.put(grammarAccess.getAccionAccess().getPrefijoAssignment_2_2(), "rule__Accion__PrefijoAssignment_2_2");
			builder.put(grammarAccess.getCondicionPuertoAccess().getNameAssignment_1(), "rule__CondicionPuerto__NameAssignment_1");
