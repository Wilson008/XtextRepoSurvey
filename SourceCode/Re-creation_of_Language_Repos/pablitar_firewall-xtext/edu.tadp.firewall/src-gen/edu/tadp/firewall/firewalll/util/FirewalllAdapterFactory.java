...
public class FirewalllAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FirewalllSwitch<Adapter> modelSwitch =
    new FirewalllSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseLoggearAccion(LoggearAccion object)
      {
        return createLoggearAccionAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link edu.tadp.firewall.firewalll.LoggearAccion <em>Loggear Accion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLoggearAccionAdapter()
  {
    return null;
  }
