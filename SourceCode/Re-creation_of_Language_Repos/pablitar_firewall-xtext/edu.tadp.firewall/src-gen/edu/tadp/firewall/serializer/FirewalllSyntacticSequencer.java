...
public class FirewalllSyntacticSequencer extends AbstractSyntacticSequencer {

	protected FirewalllGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (FirewalllGrammarAccess) access;
