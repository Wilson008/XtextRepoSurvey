...
public class FirewalllSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == FirewalllPackage.eINSTANCE)
			...
			case FirewalllPackage.ACEPTAR_ACCION:
				sequence_Accion(context, (AceptarAccion) semanticObject); 
				return; 
			case FirewalllPackage.BLOQUEAR_ACCION:
				sequence_Accion(context, (BloquearAccion) semanticObject); 
				return; 
			...
			case FirewalllPackage.IP:
				...
				return; 
			case FirewalllPackage.LOGGEAR_ACCION:
				sequence_Accion(context, (LoggearAccion) semanticObject); 
				return; 
	 ...
	 * </pre>
	 */
	protected void sequence_Accion(ISerializationContext context, AceptarAccion semanticObject) {
	 ...
	 * </pre>
	 */
	protected void sequence_Accion(ISerializationContext context, BloquearAccion semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     Accion returns LoggearAccion
	 *
	 * Constraint:
	 *     prefijo=STRING
	 * </pre>
	 */
	protected void sequence_Accion(ISerializationContext context, LoggearAccion semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, FirewalllPackage.Literals.LOGGEAR_ACCION__PREFIJO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FirewalllPackage.Literals.LOGGEAR_ACCION__PREFIJO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAccionAccess().getPrefijoSTRINGTerminalRuleCall_2_2_0(), semanticObject.getPrefijo());
		feeder.finish();
	}
	...
	protected void sequence_CondicionPuerto(ISerializationContext context, CondicionPuerto semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, FirewalllPackage.Literals.CONDICION_PUERTO__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FirewalllPackage.Literals.CONDICION_PUERTO__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCondicionPuertoAccess().getNameINTTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.finish();
	}
