...
public interface FirewalllPackage extends EPackage
{
   ...
   * @ordered
   */
  int CONDICION_PUERTO__NAME = CONDICION_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link edu.tadp.firewall.firewalll.impl.LoggearAccionImpl <em>Loggear Accion</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see edu.tadp.firewall.firewalll.impl.LoggearAccionImpl
   * @see edu.tadp.firewall.firewalll.impl.FirewalllPackageImpl#getLoggearAccion()
   * @generated
   */
  int LOGGEAR_ACCION = 9;
   ...
   * @ordered
   */
  int LOGGEAR_ACCION__PREFIJO = ACCION_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Loggear Accion</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int LOGGEAR_ACCION_FEATURE_COUNT = ACCION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the attribute '{@link edu.tadp.firewall.firewalll.CondicionPuerto#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see edu.tadp.firewall.firewalll.CondicionPuerto#getName()
   * @see #getCondicionPuerto()
   * @generated
   */
  EAttribute getCondicionPuerto_Name();
  ...
  /**
   * Returns the meta object for class '{@link edu.tadp.firewall.firewalll.LoggearAccion <em>Loggear Accion</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Loggear Accion</em>'.
   * @see edu.tadp.firewall.firewalll.LoggearAccion
   * @generated
   */
  EClass getLoggearAccion();

  /**
   * Returns the meta object for the attribute '{@link edu.tadp.firewall.firewalll.LoggearAccion#getPrefijo <em>Prefijo</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Prefijo</em>'.
   * @see edu.tadp.firewall.firewalll.LoggearAccion#getPrefijo()
   * @see #getLoggearAccion()
   * @generated
   */
  EAttribute getLoggearAccion_Prefijo();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute CONDICION_PUERTO__NAME = eINSTANCE.getCondicionPuerto_Name();
    ...
    /**
     * The meta object literal for the '{@link edu.tadp.firewall.firewalll.impl.LoggearAccionImpl <em>Loggear Accion</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see edu.tadp.firewall.firewalll.impl.LoggearAccionImpl
     * @see edu.tadp.firewall.firewalll.impl.FirewalllPackageImpl#getLoggearAccion()
     * @generated
     */
    EClass LOGGEAR_ACCION = eINSTANCE.getLoggearAccion();
     ...
     * @generated
     */
    EAttribute LOGGEAR_ACCION__PREFIJO = eINSTANCE.getLoggearAccion_Prefijo();
