...
import es.unex.quercusseg.graphqlIDL.GraphqlIDLFactory;
...
public class GraphqlIDLPackageImpl extends EPackageImpl implements GraphqlIDLPackage
{
   ...
   * @see es.unex.quercusseg.graphqlIDL.GraphqlIDLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static GraphqlIDLPackage init()
  {
    ...
    Object registeredGraphqlIDLPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    GraphqlIDLPackageImpl theGraphqlIDLPackage = registeredGraphqlIDLPackage instanceof GraphqlIDLPackageImpl ? (GraphqlIDLPackageImpl)registeredGraphqlIDLPackage : new GraphqlIDLPackageImpl();
