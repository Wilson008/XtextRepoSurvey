...
import org.xtext.example.checkerdsl.ide.contentassist.antlr.CheckerDslParser;
import org.xtext.example.checkerdsl.ide.contentassist.antlr.PartialCheckerDslContentAssistParser;
import org.xtext.example.checkerdsl.ide.contentassist.antlr.internal.InternalCheckerDslLexer;
import org.xtext.example.checkerdsl.ui.contentassist.CheckerDslProposalProvider;
import org.xtext.example.checkerdsl.ui.editor.CheckerDslEditor;
import org.xtext.example.checkerdsl.ui.labeling.CheckerDslDescriptionLabelProvider;
import org.xtext.example.checkerdsl.ui.labeling.CheckerDslLabelProvider;
import org.xtext.example.checkerdsl.ui.outline.CheckerDslOutlineTreeProvider;
import org.xtext.example.checkerdsl.ui.quickfix.CheckerDslQuickfixProvider;
import org.xtext.example.checkerdsl.validation.CheckerDslValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link CheckerDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCheckerDslUiModule extends DefaultXbaseUiModule {

	public AbstractCheckerDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalCheckerDslLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.example.checkerdsl.parser.antlr.internal.InternalCheckerDslLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return CheckerDslParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalCheckerDslLexer.class).toProvider(LexerProvider.create(InternalCheckerDslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return CheckerDslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return CheckerDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(CheckerDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return CheckerDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return CheckerDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return CheckerDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialCheckerDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("CheckerDsl Compare");
	}
