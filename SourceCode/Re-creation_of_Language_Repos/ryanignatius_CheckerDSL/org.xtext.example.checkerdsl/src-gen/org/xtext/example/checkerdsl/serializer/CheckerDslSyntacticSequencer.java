...
public class CheckerDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected CheckerDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (CheckerDslGrammarAccess) access;
