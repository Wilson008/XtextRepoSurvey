...
public class HlvlInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new HlvlStandaloneSetup() {
			@Override
	...
	protected HlvlRuntimeModule createRuntimeModule() {
		...
		return new HlvlRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return HlvlInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
