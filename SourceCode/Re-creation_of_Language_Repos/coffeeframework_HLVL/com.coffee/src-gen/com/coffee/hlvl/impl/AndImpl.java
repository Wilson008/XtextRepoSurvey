 ...
 * </p>
 * <ul>
 *   <li>{@link com.coffee.hlvl.impl.AndImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link com.coffee.hlvl.impl.AndImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends RelationalImpl implements And
{
  ...
  public NotificationChain basicSetLeft(Relational newLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.AND__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(Relational newLeft)
  {
    if (newLeft != left)
    {
      ...
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HlvlPackage.AND__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HlvlPackage.AND__LEFT, null, msgs);
  ...
  public NotificationChain basicSetRight(Relational newRight, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.AND__RIGHT, oldRight, newRight);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRight(Relational newRight)
  {
    if (newRight != right)
    {
      NotificationChain msgs = null;
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HlvlPackage.AND__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HlvlPackage.AND__RIGHT, null, msgs);
