...
entryRuleListOfModelRef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getListOfModelRefRule()); }
	iv_ruleListOfModelRef=ruleListOfModelRef
	{ $current=$iv_ruleListOfModelRef.current; }
	EOF;

// Rule ListOfModelRef
ruleListOfModelRef returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_Atomic_33.current;
			afterParserOrEnumRuleCall();
		}
	)
;
