...
public class HlvlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == HlvlPackage.eINSTANCE)
			...
			case HlvlPackage.LIST_OF_MODEL_REF:
				sequence_ListOfModelRef(context, (ListOfModelRef) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (name=ID extendedModels=ListOfModelRef? elements+=ElmDeclaration* relations+=RelDeclaration* operations=Operations?)
	 * </pre>
	 */
