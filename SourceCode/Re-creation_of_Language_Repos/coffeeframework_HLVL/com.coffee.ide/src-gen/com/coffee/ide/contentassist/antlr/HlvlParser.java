...
public class HlvlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, HlvlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPrimaryAccess().getOpAlternatives_6_1_0(), "rule__Primary__OpAlternatives_6_1_0");
			...
			builder.put(grammarAccess.getListOfModelRefAccess().getGroup(), "rule__ListOfModelRef__Group__0");
			builder.put(grammarAccess.getListOfModelRefAccess().getGroup_2(), "rule__ListOfModelRef__Group_2__0");
			...
			builder.put(grammarAccess.getModelAccess().getExtendedModelsAssignment_2_1(), "rule__Model__ExtendedModelsAssignment_2_1");
			builder.put(grammarAccess.getModelAccess().getElementsAssignment_4(), "rule__Model__ElementsAssignment_4");
			builder.put(grammarAccess.getModelAccess().getRelationsAssignment_6(), "rule__Model__RelationsAssignment_6");
			...
			builder.put(grammarAccess.getPrimaryAccess().getElementAssignment_5_3(), "rule__Primary__ElementAssignment_5_3");
			builder.put(grammarAccess.getPrimaryAccess().getOpAssignment_6_1(), "rule__Primary__OpAssignment_6_1");
			builder.put(grammarAccess.getPrimaryAccess().getLeftAssignment_6_3(), "rule__Primary__LeftAssignment_6_3");
			builder.put(grammarAccess.getPrimaryAccess().getRightAssignment_6_5(), "rule__Primary__RightAssignment_6_5");
